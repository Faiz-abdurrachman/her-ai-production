(function () {
    const STORAGE = {
        chapter: "heraiAiEvaluationCurrentChapter",
        ...
        readiness: "heraiAiEvaluationReadiness"
    };
    ...
    const MATERIAL_LIST_ID = 'aiEvaluationList';
...
const CHAPTERS = [
    {
        ...
        "shortTitle": "Mengapa AI Perlu ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mengapa AI Perlu Dievaluasi?",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/evaluation/chapters/01-topic.html"
    },
    {
        "title": "Mengevaluasi Output AI",
        "shortTitle": "Mengevaluasi Outp...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mengevaluasi Output AI",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/evaluation/chapters/02-topic.html"
    },
    {
        "title": "Benchmark dan Dataset Evaluasi",
        "shortTitle": "Benchmark dan Dat...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Benchmark dan Dataset Evaluasi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/evaluation/chapters/03-topic.html"
    },
    {
        "title": "Reliability dan Robustness",
        "shortTitle": "Reliability dan R...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Reliability dan Robustness",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/evaluation/chapters/04-topic.html"
    },
    {
        "title": "Bias dan Fairness",
        "shortTitle": "Bias dan Fairness",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Bias dan Fairness",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/evaluation/chapters/05-topic.html"
    },
    {
        "title": "Kualitas Sistem AI dan Evaluation Plan",
        "shortTitle": "Kualitas Sistem A...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Kualitas Sistem AI dan Evaluation Plan",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/evaluation/chapters/06-topic.html"
    }
];
...
roadmapRef: "8"
    ...
    {
        "id": "PRACTICE-1",
        "title": "Latihan 1 - Menulis Evaluation Brief",
        "prompt": "Pilih satu fitur AI. Tulis pengguna utama, tujuan, tiga kegagalan kritis, dan bukti yang harus tersedia sebelum rilis.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    {
        "id": "PRACTICE-2",
        "title": "Latihan 2 - Menilai dua jawaban",
        "prompt": "Buat dua jawaban untuk pertanyaan yang sama. Satu jawaban boleh terdengar baik tetapi memiliki satu kesalahan fakta. Nilai keduanya memakai rubrik 1-4 dan jelaskan keputusanmu.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    {
        "id": "PRACTICE-3",
        "title": "Latihan 3 - Membuat lima kasus evaluasi",
        "prompt": "Buat lima item: satu pertanyaan normal, satu informal, satu ambigu, satu tidak memiliki sumber, dan satu prompt injection. Tentukan expected behavior setiap kasus.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    {
        "id": "PRACTICE-5",
        "title": "Latihan 5 - Membaca dampak kesalahan",
        "prompt": "Untuk fitur AI screening atau rekomendasi, jelaskan siapa yang dirugikan oleh false positive dan false negative. Tentukan minimal dua metrik per kelompok.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
...
var SOURCE_VISUALS = {
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiEvaluationChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiEvaluationChallengeCh" + chapterNumber;
    ...
    function renderMaterialProgress(chapterNumber, total) {
        ...
        if (progressB) {
            ...
            progressB.setAttribute("aria-label", percent + "% progres Evaluation");
        }
    ...
    window.loadAiEvaluationChapter = function (chapterNumber) {
    ...
    window.initAiEvaluationMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" title="${escapeHtml(chapter.title)}" onclick="window.loadAiEvaluationChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle" aria-hidden="true"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiEvaluationChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiEvaluationChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiEvaluationChapter(initial);
    };
    ...
    var PRACTICE_TOPICS = [ { start: 0, end: 4, label: "Latihan Modul" } ];
    ...
    window.initAiEvaluationPractice = function () {
        const form = document.getElementById("aiEvaluationPracticeForm");
        const practiceList = document.getElementById("aiEvaluationPracticeList");
        if (!form || !practiceList) return;

        const refNode = document.getElementById("aiEvaluationPracticeSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiEvaluationPracticeNavigator");
        const counter = document.getElementById("aiEvaluationPracticeCounter");
        ...
        setStatus("#aiEvaluationPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiEvaluationPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
        ...
        if (saveButton) {
            saveButton.addEventListener("click", async function () {
                ...
                if (filledCount < totalFields) {
                    ...
                    setStatus("#aiEvaluationPracticeStatus", "Isi seluruh " + totalFields + " jawaban sebelum mengirim. " + (totalFields - filledCount) + " jawaban masih kosong.", "warning");
                ...
                window.noteParticipantExerciseSubmission(form, "#aiEvaluationPracticeStatus", result.submission);
                setStatus("#aiEvaluationPracticeStatus", "Latihan Evaluation AI berhasil dikirim dan menunggu review mentor.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiEvaluationPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiEvaluationPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
        window.bindParticipantExerciseForm({
            form: form,
            moduleId: MODULE_ID,
            statusSelector: "#aiEvaluationPracticeStatus",
            ...
            setMessage: function (message, type) { setStatus("#aiEvaluationPracticeStatus", message, type); },
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiEvaluationQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiEvaluationQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiEvaluationQuizCounter");
        ...
        const next = document.getElementById("aiEvaluationQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiEvaluationQuiz = function () {
        const form = document.getElementById("aiEvaluationQuizForm");
        const list = document.getElementById("aiEvaluationQuizList");
        if (!form || !list) return;

        const refNode = document.getElementById("aiEvaluationQuizSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiEvaluationQuizNavigator");
        const counter = document.getElementById("aiEvaluationQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiEvaluationDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiEvaluationDiscussion = async function () {
        ...
        const refNode = document.getElementById("aiEvaluationDiscussionSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        form.addEventListener("submit", async function (event) {
            ...
            if (!text) {
                setStatus("#aiEvaluationDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
