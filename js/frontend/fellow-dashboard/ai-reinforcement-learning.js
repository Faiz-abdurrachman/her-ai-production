(function () {
    const STORAGE = {
        chapter: "heraiAiReinforcementLearningCurrentChapter",
        practice: "heraiAiReinforcementLearningPractice",
        quizDone: "heraiAiReinforcementLearningQuizDone",
        quizScore: "heraiAiReinforcementLearningQuizScore",
        quizAnswers: "heraiAiReinforcementLearningQuizAnswers",
        discussion: "heraiAiReinforcementLearningDiscussion",
    ...
    const MODULE_ID = 'reinforcement-learning';
...
const CHAPTERS = [
    {
        ...
        "shortTitle": "Pengantar Reinfor...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Pengantar Reinforcement Learning",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/01-topic.html"
    },
    {
        "title": "Agent, Environment, dan Markov Decision Process",
        "shortTitle": "Agent, Environmen...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Agent, Environment, dan Markov Decision Process",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/02-topic.html"
    },
    {
        "title": "Reward, Return, dan Discount Factor",
        "shortTitle": "Reward, Return, d...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Reward, Return, dan Discount Factor",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/03-topic.html"
    },
    {
        "title": "Policy, Value Function, dan Bellman Intuition",
        "shortTitle": "Policy, Value Fun...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Policy, Value Function, dan Bellman Intuition",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/04-topic.html"
    },
    {
        "title": "Exploration vs Exploitation",
        "shortTitle": "Exploration vs Ex...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Exploration vs Exploitation",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/05-topic.html"
    },
    {
        "title": "Monte Carlo dan Temporal-Difference Learning",
        "shortTitle": "Monte Carlo dan T...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Monte Carlo dan Temporal-Difference Learning",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/06-topic.html"
    },
    {
        "title": "SARSA dan Q-Learning",
        "shortTitle": "SARSA dan Q-Learning",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai SARSA dan Q-Learning",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/07-topic.html"
    },
    {
        "title": "Function Approximation dan Deep Q-Network",
        "shortTitle": "Function Approxim...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Function Approximation dan Deep Q-Network",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/08-topic.html"
    },
    {
        "title": "Policy Gradient, Actor-Critic, dan PPO",
        "shortTitle": "Policy Gradient, ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Policy Gradient, Actor-Critic, dan PPO",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/09-topic.html"
    },
    {
        "title": "Reward Design, Stabilitas, dan Responsible RL",
        "shortTitle": "Reward Design, St...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Reward Design, Stabilitas, dan Responsible RL",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/10-topic.html"
    },
    {
        "title": "Evaluasi dan Eksperimen RL",
        "shortTitle": "Evaluasi dan Eksp...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Evaluasi dan Eksperimen RL",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/11-topic.html"
    },
    {
        "title": "Mini Project: Q-Learning pada GridWorld",
        "shortTitle": "Mini Project: Q-L...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: Q-Learning pada GridWorld",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/12-topic.html"
    },
    {
        "title": "Kuis Akhir",
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/foundation-core-ai/reinforcement-learning/chapters/13-topic.html"
    }
];
...
hook: {
                ...
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
                },
                answerB: {
                    label: "Fakta",
                    text: "Pemahaman benar berdasarkan bukti dan praktik.",
                    icon: "fas fa-check-circle"
                },
                message: "Reinforcement Learning atau RL adalah cara melatih sistem agar dapat mengambil keputusan melalui interaksi. Sistem yang belajar disebut agent. Dunia tempat agent bertindak disebut environment. Setiap kali agent melakukan suatu action, environment memberikan kondisi baru dan sinyal penilaian yang disebut reward.\n\nTujuan agent bukan sekadar mendapatkan reward terbesar pada satu langkah. Tujuan utamanya adalah memilih rangkaian keputusan yang menghasilkan total reward jangka panjang sebaik mungkin."
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
                ["Verifikasi", "Kerjakan checkpoint dan latihan."]
            ],
deepDive: [
                ["Apa itu Reinforcement Learning?", "Apa itu Reinforcement Learning?\n\nReinforcement Learning atau RL adalah cara melatih sistem agar dapat mengambil keputusan melalui interaksi. Sistem yang belajar disebut **agent**. Dunia tempat agent bertindak disebut **environment**. Setiap kali agent melakukan suatu **action**, environment memberikan kondisi baru dan sinyal penilaian yang disebut **reward**.\n\nTujuan agent bukan sekadar mendapatkan reward terbesar pada satu langkah. Tujuan utamanya adalah memilih rangkaian keputusan yang menghasilkan **total reward jangka panjang** sebaik mungkin.", "Bayangkan seseorang belajar bermain gim tanpa diberi kunci jawaban untuk setiap gerakan. Ia mencoba tindakan, melihat hasilnya, menerima skor, lalu memperbaiki strategi. Inilah pola dasar RL:\n\n```text\nagent memilih action\n        ↓\nenvironment berubah\n        ↓\nagent menerima state baru dan reward\n        ↓\nagent memperbaiki strategi\n```"]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Apa itu Reinforcement Learning?\n\nReinforcement Learning atau RL adalah cara melatih sistem agar dapat mengambil keputusan melalui interaksi. Sistem yang belajar disebut **agent**. Dunia tempat agent bertindak disebut **environment**. Setiap kali agent melakukan suatu **action**, environment memberik"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Mengapa reward berbeda dari label pada supervised learning?",
...
roadmapRef: "1"
        ...
        {
hook: {
                question: "Siklus Agent-Environment",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
...
roadmapRef: "2"
        ...
        {
hook: {
                question: "Reward Bukan Tujuan yang Sempurna",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
...
deepDive: [
                ["Reward Bukan Tujuan yang Sempurna", "Reward Bukan Tujuan yang Sempurna\n\nReward adalah angka yang digunakan untuk mengarahkan proses belajar. Reward bukan selalu representasi sempurna dari tujuan manusia.\n\nContoh: jika robot hanya diberi reward untuk bergerak cepat, robot dapat memilih jalur berbahaya. Jika sistem belajar hanya diberi reward berdasarkan waktu penggunaan, sistem mungkin mendorong interaksi berlebihan, bukan pembelajaran yang sehat.", "Karena itu, reward harus dirancang dengan mempertimbangkan:\n\n- tujuan utama,\n- batasan keselamatan,\n- dampak jangka panjang,\n- kemungkinan agent mencari celah,\n- kelompok pengguna yang mungkin dirugikan."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Reward Bukan Tujuan yang Sempurna\n\nReward adalah angka yang digunakan untuk mengarahkan proses belajar. Reward bukan selalu representasi sempurna dari tujuan manusia.\n\nContoh: jika robot hanya diberi reward untuk bergerak cepat, robot dapat memilih jalur berbahaya. Jika sistem belajar hanya diberi r"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa perbedaan reward dan return?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
hook: {
                ...
                message: "Policy adalah strategi agent dalam memilih action berdasarkan state.\n\nPolicy deterministik:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
quickCheck: {
                question: "Apa perbedaan V(s) dan Q(s,a)?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
deepDive: [
                ["Dilema Utama", "Dilema Utama\n\nAgent harus memilih antara:", "- **Exploitation:** memilih action yang saat ini terlihat paling baik.\n- **Exploration:** mencoba action lain untuk memperoleh informasi baru.\n\nTerlalu banyak exploitation membuat agent cepat puas pada strategi yang mungkin belum optimal. Terlalu banyak exploration membuat hasil tidak stabil dan dapat membuang sumber daya."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Dilema Utama\n\nAgent harus memilih antara:\n\n- **Exploitation:** memilih action yang saat ini terlihat paling baik.\n- **Exploration:** mencoba action lain untuk memperoleh informasi baru.\n\nTerlalu banyak exploitation membuat agent cepat puas pada strategi yang mungkin belum optimal. Terlalu banyak exp"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa risiko exploitation terlalu dini?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
hook: {
                ...
                message: "Pada banyak kasus, agent tidak mengetahui aturan transisi environment. Agent hanya memiliki pengalaman:\n\n``text\n(state, action, reward, next_state)\n``"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Model-Free Learning\n\nPada banyak kasus, agent tidak mengetahui aturan transisi environment. Agent hanya memiliki pengalaman:\n\n```text\n(state, action, reward, next_state)\n```\n\nMetode yang belajar langsung dari pengalaman tanpa model transisi lengkap disebut **model-free**.\n\nDua keluarga dasar:\n\n- Mon"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Mengapa Monte Carlo perlu menunggu episode selesai?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
challenge: {
                instruction: "Hitung return Monte Carlo dari setiap langkah.",
...
hook: {
                ...
                message: "Policy evaluation hanya menilai policy. Pada control problem, agent ingin menemukan policy yang semakin baik.\n\nSARSA dan Q-learning mempelajari action-value Q(s,a), lalu menggunakan nilai itu untuk memilih action."
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
deepDive: [
                ["Control Problem", "Control Problem\n\nPolicy evaluation hanya menilai policy. Pada control problem, agent ingin menemukan policy yang semakin baik.", "SARSA dan Q-learning mempelajari action-value `Q(s,a)`, lalu menggunakan nilai itu untuk memilih action."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Control Problem\n\nPolicy evaluation hanya menilai policy. Pada control problem, agent ingin menemukan policy yang semakin baik.\n\nSARSA dan Q-learning mempelajari action-value `Q(s,a)`, lalu menggunakan nilai itu untuk memilih action."]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa arti on-policy dan off-policy?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
roadmapRef: "7"
        ...
        {
hook: {
                question: "Mengapa Q-Table Tidak Cukup?",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
...
deepDive: [
                ["Mengapa Q-Table Tidak Cukup?", "Mengapa Q-Table Tidak Cukup?\n\nQ-table bekerja baik ketika jumlah state-action kecil. Namun, banyak masalah memiliki:\n\n- state kontinu,\n- gambar berukuran besar,\n- kombinasi state yang sangat banyak,\n- observation yang berubah terus-menerus.\n\nMisalnya, gambar 84 x 84 piksel memiliki ruang kemungkinan sangat besar. Menyimpan satu baris Q untuk setiap gambar tidak realistis.", "Solusinya adalah **function approximation**:\n\n```text\nQ(s,a; theta)\n```\n\nModel berparameter `theta` menerima state dan menghasilkan perkiraan Q-value."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Mengapa Q-Table Tidak Cukup?\n\nQ-table bekerja baik ketika jumlah state-action kecil. Namun, banyak masalah memiliki:\n\n- state kontinu,\n- gambar berukuran besar,\n- kombinasi state yang sangat banyak,\n- observation yang berubah terus-menerus.\n\nMisalnya, gambar 84 x 84 piksel memiliki ruang kemungkinan"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Mengapa Q-table tidak cocok untuk gambar?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
const QUIZ = [
    [
        "Komponen yang memilih action dalam RL adalah ...",
        [
            "Reward",
            "Agent",
            "Dataset",
    ...
    [
        "Tujuan umum RL adalah ...",
        [
            "Memaksimalkan satu reward langsung saja",
            "Meminimalkan ukuran state",
            "Memaksimalkan expected return jangka panjang",
    ...
    [
        "State yang baik seharusnya ...",
        [
            "Selalu berupa gambar",
            "Merangkum informasi relevan untuk keputusan berikutnya",
            "Tidak berubah sepanjang episode",
            "Hanya berisi reward"
        ],
        0,
        "Penjelasan belum tersedia."
    ...
    [
        "Discount factor mendekati nol membuat agent ...",
        [
            "Lebih fokus pada reward dekat",
            "Selalu memilih action acak",
            "Tidak dapat belajar",
            "Mengabaikan reward langsung"
        ],
        0,
        "Penjelasan belum tersedia."
    ],
    [
        "V(s) memperkirakan ...",
        [
            "Probabilitas state tidak pernah muncul",
            "Return dari state ketika mengikuti policy",
            "Jumlah action yang tersedia",
    ...
    [
        "Q(s,a) memperkirakan ...",
        [
            "Return setelah mengambil action a pada state s",
            "Ukuran replay buffer",
            "Jumlah episode",
            "Nilai reward terakhir saja"
        ],
        0,
        "Penjelasan belum tersedia."
    ],
    [
        "Intuisi Bellman adalah ...",
        [
            "Nilai sekarang terdiri dari reward langsung dan nilai masa depan",
            "Semua state harus memiliki nilai sama",
            "Reward tidak diperlukan",
            "Policy tidak boleh berubah"
        ],
        0,
        "Penjelasan belum tersedia."
    ],
    [
        "Exploration diperlukan agar ...",
        [
            "Agent tidak pernah menggunakan pengetahuan lama",
            "Agent dapat menemukan action yang belum cukup dicoba",
            "Episode selalu lebih panjang",
            "Reward menjadi nol"
        ],
        0,
        "Penjelasan belum tersedia."
    ...
    [
        "Pada epsilon-greedy, epsilon menyatakan ...",
        [
            "Probabilitas eksplorasi",
            "Discount factor",
            "Learning rate",
            "Ukuran state"
        ],
    ...
    [
        "Monte Carlo memperbarui nilai ...",
        [
            "Sebelum menerima reward",
            "Setelah memperoleh return episode",
            "Tanpa pengalaman",
            "Hanya pada supervised dataset"
        ],
        0,
        "Penjelasan belum tersedia."
    ],
    [
        "Temporal-Difference disebut bootstrapping karena ...",
        [
            "Menggunakan estimasi nilai berikutnya untuk memperbarui nilai sekarang",
            "Selalu memakai neural network",
            "Tidak memiliki reward",
            "Menghapus state terminal"
        ],
        0,
        "Penjelasan belum tersedia."
    ],
    [
        "SARSA adalah on-policy karena targetnya memakai ...",
        [
            "Action acak dari policy lain",
            "Action berikutnya yang benar-benar dipilih policy saat ini",
            "Hanya reward maksimum global",
            "Dataset tetap"
        ],
        0,
        "Penjelasan belum tersedia."
    ...
    [
        "Target Q-learning memakai ...",
        [
            "Nilai minimum action berikutnya",
            "Rata-rata semua reward historis",
            "Maksimum Q pada state berikutnya",
            "Tidak ada nilai masa depan"
        ],
        0,
        "Penjelasan belum tersedia."
    ],
    [
        "Replay buffer pada DQN berguna untuk ...",
        [
            "Menyimpan model final saja",
            "Menggunakan ulang dan mengacak pengalaman training",
            "Menghapus kebutuhan target network",
    ...
    [
        "Target network membantu ...",
        [
            "Membuat target belajar lebih stabil",
            "Menambah jumlah action",
            "Mengubah state menjadi reward",
            "Menghapus exploration"
        ],
        0,
        "Penjelasan belum tersedia."
    ],
    [
        "Policy gradient mengoptimalkan ...",
        [
            "Policy secara langsung",
            "Ukuran replay buffer saja",
            "Jumlah state",
            "Label klasifikasi"
        ],
        0,
    ...
    [
        "Critic pada actor-critic berfungsi untuk ...",
        [
            "Memilih warna visualisasi",
            "Menilai state atau action dan memberi sinyal belajar",
            "Menghapus reward",
            "Menentukan hardware"
        ],
        0,
    ...
    [
        "PPO membatasi perubahan policy agar ...",
        [
            "Update tidak terlalu ekstrem",
            "Semua action memiliki probabilitas nol",
            "Policy tidak pernah belajar",
            "Reward selalu positif"
        ],
        0,
        "Penjelasan belum tersedia."
    ],
    [
        "Evaluasi RL sebaiknya ...",
        [
            "Hanya memakai satu seed terbaik",
            "Memisahkan evaluasi dari training dan memakai beberapa seed",
            "Hanya melihat loss network",
            "Mengabaikan safety violation"
        ],
        0,
        "Penjelasan belum tersedia."
    ],
    [
        "Reward hacking berarti ...",
        [
            "Agent mendapat reward tinggi melalui perilaku yang tidak sesuai tujuan sebenarnya",
            "Programmer menghapus reward",
            "Reward selalu negatif",
            "Agent menggunakan epsilon-greedy"
        ],
        0,
        "Penjelasan belum tersedia."
    ]
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>Reinforcement Learning</span><h3>Agent belajar dari konsekuensi</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiReinforcementLearningChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiReinforcementLearningChallengeCh" + chapterNumber;
    ...
    window.initAiReinforcementLearningMateri = function () {
    ...
    var PRACTICE_TOPICS = [ { start: 0, end: 10, label: "Latihan Modul" } ];
    ...
    window.initAiReinforcementLearningPractice = function () {
        const form = document.getElementById("aiReinforcementLearningPracticeForm");
        ...
        const navigator = document.getElementById("aiReinforcementLearningPracticeNavigator");
        const counter = document.getElementById("aiReinforcementLearningPracticeCounter");
        ...
        setStatus("#aiReinforcementLearningPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiReinforcementLearningPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiReinforcementLearningPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiReinforcementLearningPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiReinforcementLearningPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiReinforcementLearningQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiReinforcementLearningQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiReinforcementLearningQuizCounter");
        ...
        const next = document.getElementById("aiReinforcementLearningQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiReinforcementLearningQuiz = function () {
        const form = document.getElementById("aiReinforcementLearningQuizForm");
        ...
        const navigator = document.getElementById("aiReinforcementLearningQuizNavigator");
        const counter = document.getElementById("aiReinforcementLearningQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiReinforcementLearningDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiReinforcementLearningDiscussion = function () {
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiReinforcementLearningDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiReinforcementLearningDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
