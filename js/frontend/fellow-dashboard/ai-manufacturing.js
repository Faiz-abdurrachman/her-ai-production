(function () {
    const STORAGE = {
        chapter: "heraiAiManufacturingCurrentChapter",
        practice: "heraiAiManufacturingPractice",
        quizDone: "heraiAiManufacturingQuizDone",
        quizScore: "heraiAiManufacturingQuizScore",
        quizAnswers: "heraiAiManufacturingQuizAnswers",
        discussion: "heraiAiManufacturingDiscussion",
        readiness: "heraiAiManufacturingReadiness"
    };
...
const CHAPTERS = [
    {
        "title": "Proses Produksi dan KPI Operasi",
        "shortTitle": "Proses Produksi d...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Proses Produksi dan KPI Operasi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/01-topic.html"
    },
    {
        "title": "Sensor, IIoT, dan Integrasi OT-IT",
        "shortTitle": "Sensor, IIoT, dan...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Sensor, IIoT, dan Integrasi OT-IT",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/02-topic.html"
    },
    {
        "title": "Time-series dan Kualitas Data Industri",
        "shortTitle": "Time-series dan K...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Time-series dan Kualitas Data Industri",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/03-topic.html"
    },
    {
        "title": "Predictive Maintenance",
        "shortTitle": "Predictive Mainte...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Predictive Maintenance",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/04-topic.html"
    },
    {
        "title": "Visual Inspection dan Quality Control",
        "shortTitle": "Visual Inspection...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Visual Inspection dan Quality Control",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/05-topic.html"
    },
    {
        "title": "Process Optimization dan Control",
        "shortTitle": "Process Optimizat...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Process Optimization dan Control",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/06-topic.html"
    },
    {
        "title": "Demand, Inventory, dan Scheduling",
        "shortTitle": "Demand, Inventory...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Demand, Inventory, dan Scheduling",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/07-topic.html"
    },
    {
        "title": "Digital Twin dan Simulation",
        "shortTitle": "Digital Twin dan ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Digital Twin dan Simulation",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/08-topic.html"
    },
    {
        "title": "Edge AI dan Real-time Operation",
        "shortTitle": "Edge AI dan Real-...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Edge AI dan Real-time Operation",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/09-topic.html"
    },
    {
        "title": "Safety, Cybersecurity, MLOps, dan ROI",
        "shortTitle": "Safety, Cybersecu...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Safety, Cybersecurity, MLOps, dan ROI",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/10-topic.html"
    },
    {
        "title": "Mini Project: Predictive Maintenance Motor Produksi",
        "shortTitle": "Mini Project: Pre...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: Predictive Maintenance Motor Produksi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/11-topic.html"
    },
    {
        "title": "Kuis Akhir",
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/12-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/13-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/14-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/manufacturing/chapters/15-topic.html"
    }
];
    ...
    const PYTHON_GUIDES = [
        {
hook: {
                question: "Proses Produksi dan KPI Operasi tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu d...",
                answerA: {
                    label: "Mitos umum",
                ...
                message: "Analogi: AI di pabrik seperti sistem saraf tambahan: sensor menangkap kondisi, model mengenali pola, tetapi tindakan harus melewati kontrol keselamatan dan prosedur operasi yang jelas.\n\nPada praktiknya, kualitas bukan hanya berarti hasil tampak benar. Kualitas juga mencakup konsistensi, keterlacakan"
            },
flow: [
                ["Tentukan tujuan proses produksi dan kpi operasi...", "Tentukan tujuan proses produksi dan kpi operasi dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk cycle time serta yield."],
...
workedExample: [
                "Dalam mini project Predictive Maintenance Motor Produksi, tim perlu menerapkan proses produksi dan k",
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan cycle time, yield, OEE, downtime. Tandai asumsi dan titik kegagalan.",
...
roadmapRef: "1"
        ...
        {
hook: {
                question: "Sensor, IIoT, dan Integrasi OT-IT tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan sensor, iiot, dan integrasi ot-...", "Tentukan tujuan sensor, iiot, dan integrasi ot-it dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk sensor serta PLC."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Predictive Maintenance Motor Produksi, tim perlu menerapkan sensor, iiot, dan int",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan sensor, PLC, SCADA, historian. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "2"
        ...
        {
hook: {
                question: "Time-series dan Kualitas Data Industri tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik s...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan time-series dan kualitas data i...", "Tentukan tujuan time-series dan kualitas data industri dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk timestamp serta sampling."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Predictive Maintenance Motor Produksi, tim perlu menerapkan time-series dan kuali",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan timestamp, sampling, missing, drift. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "3"
        ...
        {
hook: {
                question: "Predictive Maintenance tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimulai da...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan predictive maintenance dan kepu...", "Tentukan tujuan predictive maintenance dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk failure mode serta condition monitoring."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Predictive Maintenance Motor Produksi, tim perlu menerapkan predictive maintenanc",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan failure mode, condition monitoring, anomaly, remaining life. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "4"
        ...
        {
hook: {
                question: "Visual Inspection dan Quality Control tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik se...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan visual inspection dan quality c...", "Tentukan tujuan visual inspection dan quality control dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk camera serta lighting."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Predictive Maintenance Motor Produksi, tim perlu menerapkan visual inspection dan",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan camera, lighting, defect, detection. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "5"
        ...
        {
hook: {
                question: "Process Optimization dan Control tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu ...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan process optimization dan contro...", "Tentukan tujuan process optimization dan control dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk setpoint serta constraint."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Predictive Maintenance Motor Produksi, tim perlu menerapkan process optimization ",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan setpoint, constraint, optimization, feedback. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "6"
        ...
        {
hook: {
                question: "Demand, Inventory, dan Scheduling tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan demand, inventory, dan scheduli...", "Tentukan tujuan demand, inventory, dan scheduling dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk forecast serta inventory."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Predictive Maintenance Motor Produksi, tim perlu menerapkan demand, inventory, da",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan forecast, inventory, lead time, capacity. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "7"
        ...
        {
hook: {
                question: "Digital Twin dan Simulation tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimul...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan digital twin dan simulation dan...", "Tentukan tujuan digital twin dan simulation dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk asset model serta state."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Predictive Maintenance Motor Produksi, tim perlu menerapkan digital twin dan simu",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan asset model, state, simulation, scenario. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "8"
    ...
    },
    {
        "id": "PRACTICE-2",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan sensor, PLC, SCADA, historian. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-3",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan timestamp, sampling, missing, drift. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-4",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan failure mode, condition monitoring, anomaly, remaining life. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-5",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan camera, lighting, defect, detection. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-6",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan setpoint, constraint, optimization, feedback. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-7",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan forecast, inventory, lead time, capacity. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-8",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan asset model, state, simulation, scenario. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-9",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan edge, latency, offline, compression. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-10",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan hazard, segmentation, access, monitoring. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>AI + Manufaktur</span><h3>Otomatisasi cerdas di lini produksi</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiManufacturingChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiManufacturingChallengeCh" + chapterNumber;
    ...
    window.loadAiManufacturingChapter = function (chapterNumber) {
    ...
    window.initAiManufacturingMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiManufacturingChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiManufacturingChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiManufacturingChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiManufacturingChapter(initial);
    };
    ...
    window.initAiManufacturingPractice = function () {
        const form = document.getElementById("aiManufacturingPracticeForm");
        const practiceList = document.getElementById("aiManufacturingPracticeList");
        if (!form || !practiceList) return;

        const refNode = document.getElementById("aiManufacturingPracticeSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiManufacturingPracticeNavigator");
        const counter = document.getElementById("aiManufacturingPracticeCounter");
        ...
        setStatus("#aiManufacturingPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiManufacturingPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiManufacturingPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiManufacturingPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiManufacturingPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiManufacturingQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiManufacturingQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiManufacturingQuizCounter");
        ...
        const next = document.getElementById("aiManufacturingQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiManufacturingQuiz = function () {
        const form = document.getElementById("aiManufacturingQuizForm");
        const list = document.getElementById("aiManufacturingQuizList");
        if (!form || !list) return;

        const refNode = document.getElementById("aiManufacturingQuizSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiManufacturingQuizNavigator");
        const counter = document.getElementById("aiManufacturingQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiManufacturingDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiManufacturingDiscussion = function () {
        const form = document.getElementById("aiManufacturingDiscussionForm");
        const select = form ? form.querySelector("select") : null;
        const textarea = form ? form.querySelector("textarea") : null;
        const refNode = document.getElementById("aiManufacturingDiscussionSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiManufacturingDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiManufacturingDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
