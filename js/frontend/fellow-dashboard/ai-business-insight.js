(function () {
    const STORAGE = {
        chapter: "heraiAiBusinessInsightCurrentChapter",
        practice: "heraiAiBusinessInsightPractice",
        quizDone: "heraiAiBusinessInsightQuizDone",
        quizScore: "heraiAiBusinessInsightQuizScore",
        quizAnswers: "heraiAiBusinessInsightQuizAnswers",
        discussion: "heraiAiBusinessInsightDiscussion",
        readiness: "heraiAiBusinessInsightReadiness"
    };
    ...
    const MODULE_ID = 'business-insight';
...
const CHAPTERS = [
    {
        "title": "Dari Pertanyaan Bisnis ke Keputusan",
        "shortTitle": "Dari Pertanyaan B...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Dari Pertanyaan Bisnis ke Keputusan",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/01-topic.html"
    },
    {
        "title": "Definisi Metrik yang Konsisten",
        "shortTitle": "Definisi Metrik y...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Definisi Metrik yang Konsisten",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/02-topic.html"
    },
    {
        "title": "Metric Tree dan KPI",
        "shortTitle": "Metric Tree dan KPI",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Metric Tree dan KPI",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/03-topic.html"
    },
    {
        "title": "Analisis Deskriptif dan Diagnostik",
        "shortTitle": "Analisis Deskript...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Analisis Deskriptif dan Diagnostik",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/04-topic.html"
    },
    {
        "title": "Segmentasi, Cohort, dan Funnel",
        "shortTitle": "Segmentasi, Cohor...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Segmentasi, Cohort, dan Funnel",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/05-topic.html"
    },
    {
        "title": "Dashboard yang Mendukung Tindakan",
        "shortTitle": "Dashboard yang Me...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Dashboard yang Mendukung Tindakan",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/06-topic.html"
    },
    {
        "title": "Eksperimen dan Pengukuran Dampak",
        "shortTitle": "Eksperimen dan Pe...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Eksperimen dan Pengukuran Dampak",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/07-topic.html"
    },
    {
        "title": "Forecast dan Scenario Planning",
        "shortTitle": "Forecast dan Scen...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Forecast dan Scenario Planning",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/08-topic.html"
    },
    {
        "title": "AI-assisted Analysis dengan Verifikasi",
        "shortTitle": "AI-assisted Analy...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai AI-assisted Analysis dengan Verifikasi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/09-topic.html"
    },
    {
        "title": "Data Storytelling dan Decision Cadence",
        "shortTitle": "Data Storytelling...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Data Storytelling dan Decision Cadence",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/10-topic.html"
    },
    {
        "title": "Mini Project: Executive Insight Pack",
        "shortTitle": "Mini Project: Exe...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: Executive Insight Pack",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/11-topic.html"
    },
    {
        "title": "Kuis Akhir",
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/12-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/13-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/14-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/business-insight/chapters/15-topic.html"
    }
];
    ...
    const PYTHON_GUIDES = [
        {
hook: {
                question: "Dari Pertanyaan Bisnis ke Keputusan tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik sela...",
                answerA: {
                    label: "Mitos umum",
                ...
                message: "Analogi: Insight seperti lampu sorot di ruang gelap: bukan menerangi semua hal sekaligus, tetapi menyorot bagian yang paling penting untuk keputusan berikutnya.\n\nPada praktiknya, kualitas bukan hanya berarti hasil tampak benar. Kualitas juga mencakup konsistensi, keterlacakan, keamanan, biaya, kemam"
            },
flow: [
                ["Tentukan tujuan dari pertanyaan bisnis ke keput...", "Tentukan tujuan dari pertanyaan bisnis ke keputusan dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk decision serta stakeholder."],
...
workedExample: [
                "Dalam mini project Executive Insight Pack, tim perlu menerapkan dari pertanyaan bisnis ke keputusan ",
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan decision, stakeholder, scope, hypothesis. Tandai asumsi dan titik kegagalan.",
...
roadmapRef: "1"
        ...
        {
hook: {
                question: "Definisi Metrik yang Konsisten tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu di...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan definisi metrik yang konsisten ...", "Tentukan tujuan definisi metrik yang konsisten dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk metric serta numerator."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Executive Insight Pack, tim perlu menerapkan definisi metrik yang konsisten secar",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan metric, numerator, denominator, grain. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "2"
        ...
        {
hook: {
                question: "Metric Tree dan KPI tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimulai dari ...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan metric tree dan kpi dan keputus...", "Tentukan tujuan metric tree dan kpi dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk outcome serta driver."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Executive Insight Pack, tim perlu menerapkan metric tree dan kpi secara bertahap.",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan outcome, driver, leading, lagging. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "3"
        ...
        {
hook: {
                question: "Analisis Deskriptif dan Diagnostik tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selal...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan analisis deskriptif dan diagnos...", "Tentukan tujuan analisis deskriptif dan diagnostik dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk trend serta variance."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Executive Insight Pack, tim perlu menerapkan analisis deskriptif dan diagnostik s",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan trend, variance, benchmark, decomposition. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "4"
        ...
        {
hook: {
                question: "Segmentasi, Cohort, dan Funnel tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu di...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan segmentasi, cohort, dan funnel ...", "Tentukan tujuan segmentasi, cohort, dan funnel dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk segment serta cohort."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Executive Insight Pack, tim perlu menerapkan segmentasi, cohort, dan funnel secar",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan segment, cohort, retention, conversion. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "5"
        ...
        {
hook: {
                question: "Dashboard yang Mendukung Tindakan tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan dashboard yang mendukung tindak...", "Tentukan tujuan dashboard yang mendukung tindakan dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk hierarchy serta context."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Executive Insight Pack, tim perlu menerapkan dashboard yang mendukung tindakan se",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan hierarchy, context, alert, drill-down. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "6"
        ...
        {
hook: {
                question: "Eksperimen dan Pengukuran Dampak tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu ...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan eksperimen dan pengukuran dampa...", "Tentukan tujuan eksperimen dan pengukuran dampak dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk hypothesis serta treatment."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Executive Insight Pack, tim perlu menerapkan eksperimen dan pengukuran dampak sec",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan hypothesis, treatment, control, lift. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "7"
        ...
        {
hook: {
                question: "Forecast dan Scenario Planning tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu di...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan forecast dan scenario planning ...", "Tentukan tujuan forecast dan scenario planning dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk forecast serta assumption."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Executive Insight Pack, tim perlu menerapkan forecast dan scenario planning secar",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan forecast, assumption, base, upside. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "8"
    ...
    },
    {
        "id": "PRACTICE-2",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan metric, numerator, denominator, grain. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-3",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan outcome, driver, leading, lagging. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-4",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan trend, variance, benchmark, decomposition. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-5",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan segment, cohort, retention, conversion. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-6",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan hierarchy, context, alert, drill-down. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-7",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan hypothesis, treatment, control, lift. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-8",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan forecast, assumption, base, upside. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-9",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan copilot, query, summarization, citation. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-10",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan audience, narrative, evidence, recommendation. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>Business Insight</span><h3>Dari data menjadi keputusan strategis</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiBusinessInsightChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiBusinessInsightChallengeCh" + chapterNumber;
    ...
    window.loadAiBusinessInsightChapter = function (chapterNumber) {
    ...
    window.initAiBusinessInsightMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiBusinessInsightChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiBusinessInsightChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiBusinessInsightChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiBusinessInsightChapter(initial);
    };
    ...
    window.initAiBusinessInsightPractice = function () {
        const form = document.getElementById("aiBusinessInsightPracticeForm");
        const practiceList = document.getElementById("aiBusinessInsightPracticeList");
        if (!form || !practiceList) return;

        const refNode = document.getElementById("aiBusinessInsightPracticeSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiBusinessInsightPracticeNavigator");
        const counter = document.getElementById("aiBusinessInsightPracticeCounter");
        ...
        setStatus("#aiBusinessInsightPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiBusinessInsightPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiBusinessInsightPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiBusinessInsightPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiBusinessInsightPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiBusinessInsightQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiBusinessInsightQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiBusinessInsightQuizCounter");
        ...
        const next = document.getElementById("aiBusinessInsightQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiBusinessInsightQuiz = function () {
        const form = document.getElementById("aiBusinessInsightQuizForm");
        const list = document.getElementById("aiBusinessInsightQuizList");
        if (!form || !list) return;

        const refNode = document.getElementById("aiBusinessInsightQuizSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiBusinessInsightQuizNavigator");
        const counter = document.getElementById("aiBusinessInsightQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiBusinessInsightDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiBusinessInsightDiscussion = function () {
        const form = document.getElementById("aiBusinessInsightDiscussionForm");
        const select = form ? form.querySelector("select") : null;
        const textarea = form ? form.querySelector("textarea") : null;
        const refNode = document.getElementById("aiBusinessInsightDiscussionSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiBusinessInsightDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiBusinessInsightDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
