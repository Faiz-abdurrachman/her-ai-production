(function () {
    const STORAGE = {
        chapter: "heraiAiAgenticAiCurrentChapter",
        practice: "heraiAiAgenticAiPractice",
        quizDone: "heraiAiAgenticAiQuizDone",
        quizScore: "heraiAiAgenticAiQuizScore",
        quizAnswers: "heraiAiAgenticAiQuizAnswers",
        discussion: "heraiAiAgenticAiDiscussion",
...
const CHAPTERS = [
    {
        "title": "Mengenal Agentic AI",
        "shortTitle": "Mengenal Agentic AI",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mengenal Agentic AI",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/01-topic.html"
    },
    {
        "title": "Komponen Inti AI Agent",
        "shortTitle": "Komponen Inti AI ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Komponen Inti AI Agent",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/02-topic.html"
    },
    {
        "title": "Workflow, Agent, dan Tingkat Otonomi",
        "shortTitle": "Workflow, Agent, ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Workflow, Agent, dan Tingkat Otonomi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/03-topic.html"
    },
    {
        "title": "Agent Loop, Planning, dan Decomposition",
        "shortTitle": "Agent Loop, Plann...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Agent Loop, Planning, dan Decomposition",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/04-topic.html"
    },
    {
        "title": "Tool Calling yang Aman dan Andal",
        "shortTitle": "Tool Calling yang...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Tool Calling yang Aman dan Andal",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/05-topic.html"
    },
    {
        "title": "State, Memory, dan Context Management",
        "shortTitle": "State, Memory, da...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai State, Memory, dan Context Management",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/06-topic.html"
    },
    {
        "title": "Pola Orkestrasi Agentic",
        "shortTitle": "Pola Orkestrasi A...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Pola Orkestrasi Agentic",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/07-topic.html"
    },
    {
        ...
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Multi-Agent Systems",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/08-topic.html"
    },
    {
        "title": "Agentic RAG dan Integrasi Pengetahuan",
        "shortTitle": "Agentic RAG dan I...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Agentic RAG dan Integrasi Pengetahuan",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/09-topic.html"
    },
    {
        "title": "Reliability, Error Handling, dan Human Approval",
        "shortTitle": "Reliability, Erro...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Reliability, Error Handling, dan Human Approval",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/10-topic.html"
    },
    {
        "title": "Security, Safety, dan Governance",
        "shortTitle": "Security, Safety,...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Security, Safety, dan Governance",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/11-topic.html"
    },
    {
        "title": "Evaluation, Tracing, dan Observability",
        "shortTitle": "Evaluation, Traci...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Evaluation, Tracing, dan Observability",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/12-topic.html"
    },
    {
        "title": "Deployment dan Mini Project Agent Asisten Operasional",
        "shortTitle": "Deployment dan Mi...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Deployment dan Mini Project Agent Asisten Operasional",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/13-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/14-topic.html"
    },
    {
        "title": "Glosarium, Ringkasan, Checklist, dan Referensi",
        "shortTitle": "Glosarium, Ringka...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Glosarium, Ringkasan, Checklist, dan Referensi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/agentic-ai/chapters/15-topic.html"
    }
];
...
deepDive: [
                ["Gambaran Umum", "Gambaran Umum\n\nSebuah agent umumnya dibangun dari enam komponen:\n\n1. **Model** - menafsirkan konteks dan memilih tindakan.\n2. **Instructions** - menjelaskan peran, tujuan, aturan, dan batas.\n3. **Tools** - fungsi yang dapat digunakan untuk berinteraksi dengan sistem lain.\n4. **State** - informasi tentang kondisi pekerjaan saat ini.\n5. **Memory** - informasi yang dipertahankan untuk penggunaan selanjutnya.\n6. **Runtime atau orchestrator** - mengelola loop, tool call, error, batas, dan tracing.", "Tambahan yang wajib untuk produksi:\n\n- guardrails;\n- approval gates;\n- observability;\n- evaluation;\n- security controls."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Gambaran Umum\n\nSebuah agent umumnya dibangun dari enam komponen:\n\n1. **Model** - menafsirkan konteks dan memilih tindakan.\n2. **Instructions** - menjelaskan peran, tujuan, aturan, dan batas.\n3. **Tools** - fungsi yang dapat digunakan untuk berinteraksi dengan sistem lain.\n4. **State** - informasi te"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa fungsi runtime dalam sistem agentic?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
roadmapRef: "2"
        ...
        {
hook: {
                question: "Workflow Deterministik",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
                ...
                message: "Workflow deterministik memiliki jalur yang sudah ditentukan. Input yang sama cenderung melewati urutan langkah yang sama.\n\nContoh:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
challenge: {
                instruction: "Menghitung total nilai dari tabel.",
...
roadmapRef: "3"
        ...
        {
hook: {
                question: "Siklus Plan-Act-Observe-Evaluate",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
...
deepDive: [
                ["Siklus Plan-Act-Observe-Evaluate", "Siklus Plan-Act-Observe-Evaluate\n\nAgent loop dapat dijelaskan dengan empat tahap:", "1. **Plan** - memilih langkah atau subtugas.\n2. **Act** - menjalankan tool atau menghasilkan tindakan.\n3. **Observe** - membaca hasil tindakan.\n4. **Evaluate** - menilai kemajuan dan menentukan langkah selanjutnya.\n\n```text\nGoal\n ↓\nPlan → Act → Observe → Evaluate\n ↑                         ↓\n └──── lanjut / revisi / berhenti\n```"]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Siklus Plan-Act-Observe-Evaluate\n\nAgent loop dapat dijelaskan dengan empat tahap:\n\n1. **Plan** - memilih langkah atau subtugas.\n2. **Act** - menjalankan tool atau menghasilkan tindakan.\n3. **Observe** - membaca hasil tindakan.\n4. **Evaluate** - menilai kemajuan dan menentukan langkah selanjutnya.\n\n`"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa perbedaan upfront planning dan incremental planning?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
hook: {
                ...
                message: "Tool bukan sekadar fungsi yang bisa dipanggil model. Tool adalah kontrak antara model dan sistem.\n\nKontrak tersebut mencakup:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
deepDive: [
                ["Tool sebagai Kontrak", "Tool sebagai Kontrak\n\nTool bukan sekadar fungsi yang bisa dipanggil model. Tool adalah kontrak antara model dan sistem.", "Kontrak tersebut mencakup:\n\n- nama;\n- deskripsi;\n- parameter;\n- tipe data;\n- nilai yang diizinkan;\n- hasil;\n- jenis error;\n- efek samping;\n- aturan izin."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Tool sebagai Kontrak\n\nTool bukan sekadar fungsi yang bisa dipanggil model. Tool adalah kontrak antara model dan sistem.\n\nKontrak tersebut mencakup:\n\n- nama;\n- deskripsi;\n- parameter;\n- tipe data;\n- nilai yang diizinkan;\n- hasil;\n- jenis error;\n- efek samping;\n- aturan izin."]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa arti tool sebagai kontrak?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
roadmapRef: "5"
        ...
        {
hook: {
                question: "Mengapa Context Management Penting?",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
...
deepDive: [
                ["Mengapa Context Management Penting?", "Mengapa Context Management Penting?\n\nAgent dapat mengalami kegagalan bukan karena model lemah, tetapi karena konteks:", "- terlalu panjang;\n- berisi data tidak relevan;\n- mencampur beberapa pengguna;\n- memuat informasi lama;\n- tidak mencatat hasil tool;\n- kehilangan keputusan sebelumnya.\n\nContext management adalah proses memilih informasi yang tepat untuk langkah yang tepat."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Mengapa Context Management Penting?\n\nAgent dapat mengalami kegagalan bukan karena model lemah, tetapi karena konteks:\n\n- terlalu panjang;\n- berisi data tidak relevan;\n- mencampur beberapa pengguna;\n- memuat informasi lama;\n- tidak mencatat hasil tool;\n- kehilangan keputusan sebelumnya.\n\nContext mana"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa fungsi state machine?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
roadmapRef: "6"
        ...
        {
hook: {
                question: "Mengapa Menggunakan Pola?",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
                ...
                message: "Pola orkestrasi membantu tim membangun sistem yang dapat dipahami. Daripada membiarkan model memilih semua hal, kita menentukan struktur kolaborasi.\n\nPola umum:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
deepDive: [
                ["Mengapa Menggunakan Pola?", "Mengapa Menggunakan Pola?\n\nPola orkestrasi membantu tim membangun sistem yang dapat dipahami. Daripada membiarkan model memilih semua hal, kita menentukan struktur kolaborasi.", "Pola umum:\n\n- prompt chaining;\n- routing;\n- parallelization;\n- evaluator-optimizer;\n- orchestrator-worker;\n- human-in-the-loop;\n- event-driven agent."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Mengapa Menggunakan Pola?\n\nPola orkestrasi membantu tim membangun sistem yang dapat dipahami. Daripada membiarkan model memilih semua hal, kita menentukan struktur kolaborasi.\n\nPola umum:\n\n- prompt chaining;\n- routing;\n- parallelization;\n- evaluator-optimizer;\n- orchestrator-worker;\n- human-in-the-l"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Kapan parallelization aman digunakan?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
hook: {
                ...
                message: "Multi-agent system menggunakan lebih dari satu agent atau worker dengan peran berbeda. Tujuannya bukan membuat sistem tampak lebih kompleks, tetapi memisahkan tanggung jawab yang memang berbeda.\n\nContoh peran:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
deepDive: [
                ["Apa Itu Multi-Agent System?", "Apa Itu Multi-Agent System?\n\nMulti-agent system menggunakan lebih dari satu agent atau worker dengan peran berbeda. Tujuannya bukan membuat sistem tampak lebih kompleks, tetapi memisahkan tanggung jawab yang memang berbeda.", "Contoh peran:\n\n- triage agent;\n- research agent;\n- data agent;\n- policy agent;\n- reviewer agent;\n- coordinator agent."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Apa Itu Multi-Agent System?\n\nMulti-agent system menggunakan lebih dari satu agent atau worker dengan peran berbeda. Tujuannya bukan membuat sistem tampak lebih kompleks, tetapi memisahkan tanggung jawab yang memang berbeda.\n\nContoh peran:\n\n- triage agent;\n- research agent;\n- data agent;\n- policy age"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Mengapa single agent sebaiknya menjadi titik awal?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>Agentic AI</span><h3>AI yang bertindak secara otonom</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiAgenticAiChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiAgenticAiChallengeCh" + chapterNumber;
    ...
    window.loadAiAgenticAiChapter = function (chapterNumber) {
    ...
    window.initAiAgenticAiMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiAgenticAiChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiAgenticAiChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiAgenticAiChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiAgenticAiChapter(initial);
    };
    ...
    window.initAiAgenticAiPractice = function () {
        const form = document.getElementById("aiAgenticAiPracticeForm");
        ...
        const navigator = document.getElementById("aiAgenticAiPracticeNavigator");
        const counter = document.getElementById("aiAgenticAiPracticeCounter");
        ...
        setStatus("#aiAgenticAiPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiAgenticAiPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiAgenticAiPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiAgenticAiPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiAgenticAiPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiAgenticAiQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiAgenticAiQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiAgenticAiQuizCounter");
        ...
        const next = document.getElementById("aiAgenticAiQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiAgenticAiQuiz = function () {
        const form = document.getElementById("aiAgenticAiQuizForm");
        ...
        const navigator = document.getElementById("aiAgenticAiQuizNavigator");
        const counter = document.getElementById("aiAgenticAiQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiAgenticAiDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiAgenticAiDiscussion = function () {
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiAgenticAiDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiAgenticAiDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
