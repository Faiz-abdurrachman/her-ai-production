(function () {
    const STORAGE = {
        chapter: "heraiAiDeploymentCurrentChapter",
        practice: "heraiAiDeploymentPractice",
        quizDone: "heraiAiDeploymentQuizDone",
        quizScore: "heraiAiDeploymentQuizScore",
        quizAnswers: "heraiAiDeploymentQuizAnswers",
        discussion: "heraiAiDeploymentDiscussion",
        readiness: "heraiAiDeploymentReadiness"
    };
...
const CHAPTERS = [
    {
        "title": "Siklus Hidup Deployment AI",
        "shortTitle": "Siklus Hidup Depl...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Siklus Hidup Deployment AI",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/01-topic.html"
    },
    {
        "title": "Packaging Model dan Registry",
        "shortTitle": "Packaging Model d...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Packaging Model dan Registry",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/02-topic.html"
    },
    {
        "title": "Pola Batch, API, Stream, dan Edge",
        "shortTitle": "Pola Batch, API, ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Pola Batch, API, Stream, dan Edge",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/03-topic.html"
    },
    {
        "title": "Model Serving dan Resource Management",
        "shortTitle": "Model Serving dan...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Model Serving dan Resource Management",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/04-topic.html"
    },
    {
        "title": "API Contract dan Penanganan Error",
        "shortTitle": "API Contract dan ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai API Contract dan Penanganan Error",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/05-topic.html"
    },
    {
        "title": "CI/CD dan Quality Gate",
        "shortTitle": "CI/CD dan Quality...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai CI/CD dan Quality Gate",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/06-topic.html"
    },
    {
        "title": "Strategi Rilis dan Rollback",
        "shortTitle": "Strategi Rilis da...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Strategi Rilis dan Rollback",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/07-topic.html"
    },
    {
        "title": "Monitoring Model dan Data",
        "shortTitle": "Monitoring Model ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Monitoring Model dan Data",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/08-topic.html"
    },
    {
        "title": "Optimasi Performa dan Biaya",
        "shortTitle": "Optimasi Performa...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Optimasi Performa dan Biaya",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/09-topic.html"
    },
    {
        "title": "Keamanan dan Incident Response",
        "shortTitle": "Keamanan dan Inci...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Keamanan dan Incident Response",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/10-topic.html"
    },
    {
        "title": "Mini Project: API Prediksi dengan Canary Release",
        "shortTitle": "Mini Project: API...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: API Prediksi dengan Canary Release",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/11-topic.html"
    },
    {
        "title": "Kuis Akhir",
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/12-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/13-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/14-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/deployment/chapters/15-topic.html"
    }
];
    ...
    const PYTHON_GUIDES = [
        {
hook: {
                question: "Siklus Hidup Deployment AI tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimula...",
                answerA: {
                    label: "Mitos umum",
                ...
                message: "Analogi: Deployment seperti membuka restoran dari resep percobaan: selain rasa, dibutuhkan dapur, standar porsi, antrean, kontrol kualitas, keamanan, dan prosedur ketika terjadi masalah.\n\nPada praktiknya, kualitas bukan hanya berarti hasil tampak benar. Kualitas juga mencakup konsistensi, keterlacak"
            },
flow: [
                ["Tentukan tujuan siklus hidup deployment ai dan ...", "Tentukan tujuan siklus hidup deployment ai dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk artifact serta environment."],
...
workedExample: [
                "Dalam mini project API Prediksi dengan Canary Release, tim perlu menerapkan siklus hidup deployment ",
...
glossary: [
                ["artifact", "Output build yang siap di-deploy: JAR, Docker image, wheel (.py), executable. Artifact versioning: setiap build punya tag unik. Reproducibility: build yang sama = artifact yang sama."],
                ["environment", "Tempat model dijalankan: development, staging, production. Environment harus konsisten: OS, library, dependency. Infrastruktur as code: environment dikonfigurasi via kode."],
                ["release", "Versi spesifik dari aplikasi/model yang dirilis ke produksi. Release notes: apa yang berubah, kenapa, risiko apa. Rollback plan: bagaimana jika release menyebabkan masalah."],
                ["runtime", "Platform yang menjalankan model: Docker container, serverless function, Kubernetes pod. Runtime menyediakan resource (CPU, RAM, GPU) dan dependency."],
                ["feedback", "Data dari deployment yang digunakan untuk improvement model: user action, prediction outcome, human feedback. Tanpa feedback loop, model tidak bisa belajar dari error."],
                ["ownership", "Tim/orang yang bertanggung jawab atas model di produksi: monitoring, maintenance, retraining. Model tanpa owner = model yang tidak terawat."]
            ],
quickCheck: {
                question: "Jelaskan artifact dengan kalimat sendiri dan berikan satu contoh.",
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan artifact, environment, release, runtime. Tandai asumsi dan titik kegagalan.",
...
roadmapRef: "1"
        ...
        {
hook: {
                question: "Packaging Model dan Registry tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan packaging model dan registry da...", "Tentukan tujuan packaging model dan registry dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk serialization serta dependency."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project API Prediksi dengan Canary Release, tim perlu menerapkan packaging model dan regi",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["serialization", "Menyimpan model ke format yang bisa di-load lagi: pickle (.pkl), ONNX (.onnx), MLflow (.mlmodel). Pilih format yang portable dan stable antar versi."],
                ["dependency", "Library yang dibutuhkan model: scikit-learn, torch, transformers. Versi harus fixed — package version drift adalah sumber bug klasik. requirements.txt atau conda env."],
                ["image", "Paket berisi kode + runtime + dependency + config. Docker image: reproducible environment. Image registry: Docker Hub, ECR, GCR. Image harus di-scan untuk vulnerability."],
                ["registry", "Penyimpanan terpusat untuk artifact/image/model. MLflow Registry, Docker Registry. Registry menyediakan versioning, metadata, dan lineage."],
                ["provenance", "Riwayat dari mana model berasal: data training apa, parameter apa, code commit mana. Provenance untuk audit: 'Model ini di-train dengan dataset versi 3, kode di commit abc123.'"],
                ["version", "Setiap perubahan model harus di-version. Semantic versioning: major.minor.patch. Breaking changes (schema change, input format) → major version bump."]
            ],
quickCheck: {
                question: "Jelaskan serialization dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan serialization, dependency, image, registry. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "2"
        ...
        {
hook: {
                question: "Pola Batch, API, Stream, dan Edge tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan pola batch, api, stream, dan ed...", "Tentukan tujuan pola batch, api, stream, dan edge dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk batch serta online."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project API Prediksi dengan Canary Release, tim perlu menerapkan pola batch, api, stream,",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["batch", "Proses data dalam group besar: prediksi semua user semalaman. Skalabilitas: proses ribuan request dalam satu job. Latency: menit-jam."],
                ["online", "Prediksi real-time saat request datang. Latency: <100ms per prediksi. Infrastruktur: REST API dengan model loaded di memory. Scaling: horizontal (tambah instance)."],
                ["stream", "Prediksi pada data streaming: fraud detection per transaksi, real-time recommendation. Input: event stream (Kafka). Output: decision stream."],
                ["edge", "Menjalankan model di perangkat (phone, IoT, on-premise), bukan di cloud. Kelebihan: latency rendah, bisa offline, data tetap lokal. Kekurangan: resource terbatas."],
                ["latency", "Waktu dari request sampai response. Target: <100ms (online), <10ms (edge), jam (batch). Latency tinggi = user experience buruk."],
                ["availability", "Persentase waktu sistem berfungsi. Target: 99.9% (9 jam downtime/tahun), 99.99% (52 menit). Trade-off: availability tinggi = infrastructure mahal."]
            ],
quickCheck: {
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan batch, online, stream, edge. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "3"
        ...
        {
hook: {
                question: "Model Serving dan Resource Management tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik se...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan model serving dan resource mana...", "Tentukan tujuan model serving dan resource management dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk server serta worker."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project API Prediksi dengan Canary Release, tim perlu menerapkan model serving dan resour",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["server", "Instance yang menjalankan model API: CPU untuk inference, GPU untuk model besar. Server management: health check, auto-recovery, load balancer."],
                ["worker", "Proses background yang menjalankan job: batch inference, feature computation, model retraining. Worker di-scale berdasarkan queue length."],
                ["concurrency", "Jumlah request yang diproses bersamaan. Concurrency tinggi = throughput tinggi. Batas: CPU/GPU resource, memory. Concurrency diatur oleh thread pool atau async worker."],
                ["GPU", "Graphics Processing Unit — chip yang mengakselerasi komputasi paralel. Diperlukan untuk training dan inference model besar (LLM, computer vision). Manajemen: VRAM monitoring, sharing antar model."],
                ["autoscaling", "Menambah/mengurangi resource berdasarkan beban. CPU > 70% → tambah instance. Request turun → kurangi instance. Horizontal scaling: tambah server, bukan upgrade server."],
                ["queue", "Antrian request yang menunggu diproses ketika semua server sibuk. Queue length = indikator perlu scaling. Jika antrian panjang terus = perlu scale up permanent."]
            ],
quickCheck: {
                question: "Jelaskan server dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan server, worker, concurrency, GPU. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "4"
        ...
        {
hook: {
                question: "API Contract dan Penanganan Error tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan api contract dan penanganan err...", "Tentukan tujuan api contract dan penanganan error dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk schema serta validation."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project API Prediksi dengan Canary Release, tim perlu menerapkan api contract dan penanga",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["schema", "Struktur input/output model: field names, types, ranges. Model serving: validasi input sesuai schema sebelum inference. Schema change = model baru (version bump)."],
                ["validation", "Memeriksa input sebelum diproses: tipe benar? range sesuai? required fields terisi? Validasi mencegah error runtime dan garbage in, garbage out."],
                ["status code", "HTTP response code: 200 (OK, response sukses), 400 (Bad Request, input salah), 500 (Internal Error, server problem). Frontend harus handle semua status code."],
                ["timeout", "Batas waktu menunggu response: 5 detik per request. Jika model butuh lebih lama → timeout error. Timeout handling: retry, fallback response, kirim ke queue async."],
                ["idempotency", "Request yang sama bisa dikirim berkali-kali dengan efek yang sama. Idempotency key di header: server deteksi duplikat dan return response yang sudah ada."],
                ["compatibility", "Model baru harus kompatibel dengan client yang sudah ada. Backward compatible: model baru bisa handle format input lama. Breaking change: tidak kompatibel — butuh endpoint baru."]
            ],
quickCheck: {
                question: "Jelaskan schema dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan schema, validation, status code, timeout. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "5"
        ...
        {
hook: {
                question: "CI/CD dan Quality Gate tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimulai da...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan ci/cd dan quality gate dan kepu...", "Tentukan tujuan ci/cd dan quality gate dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk build serta test."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project API Prediksi dengan Canary Release, tim perlu menerapkan ci/cd dan quality gate s",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["build", "Mengubah kode menjadi artifact: compile, package, test, scan. CI pipeline: trigger build setiap push. Build harus reproducible — hasil sama di mesin berbeda."],
                ["test", "Verifikasi: unit test (function level), integration test (API level), model test (accuracy tidak turun). Test failure = build gagal = tidak di-deploy."],
                ["scan", "Security scan: vulnerability di dependencies, secret exposed, malware. Image scan: Docker image di-scan sebelum registry. Policy as code: scan result menentukan pass/fail."],
                ["deploy", "Menempatkan artifact baru ke production. Deployment strategy: blue-green (cut over instan), canary (gradual), rolling (satu per satu)."],
                ["approval", "Gate sebelum deploy ke production: peer review, QA sign-off, compliance check. Approval bisa manual (human) atau otomatis (test pass + scan pass)."],
                ["artifact promotion", "Artifact pindah dari dev → staging → production. Setiap stage punya validation gates. Production hanya menerima artifact yang sudah lulus semua stage."]
            ],
quickCheck: {
                question: "Jelaskan build dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan build, test, scan, deploy. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "6"
        ...
        {
hook: {
                question: "Strategi Rilis dan Rollback tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimul...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan strategi rilis dan rollback dan...", "Tentukan tujuan strategi rilis dan rollback dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk blue-green serta canary."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project API Prediksi dengan Canary Release, tim perlu menerapkan strategi rilis dan rollb",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["blue-green", "Dua environment identik: blue (active), green (idle). Deploy ke green → switch traffic ke green → blue jadi idle. Rollback: switch balik ke blue."],
                ["canary", "Rollout bertahap: 5% traffic ke versi baru, monitor error rate, naikkan persentase jika aman. Deteksi masalah awal tanpa dampak ke semua user."],
                ["shadow", "Deploy versi baru yang menerima traffic tapi tidak mempengaruhi response user. Shadow mode: bandingkan old vs new response. Tidak ada risiko ke user."],
                ["feature flag", "Toggle untuk mengaktifkan/menonaktifkan fitur tanpa deploy. 'Fitur X enabled untuk 10% user'. Memungkinkan dark launch dan gradual rollout."],
                ["rollback", "Kembali ke versi sebelumnya jika versi baru bermasalah. Cepat: switch traffic ke artifact lama. Data migration rollback: lebih kompleks — pastikan backward compatible."],
                ["migration", "Perubahan data/schema saat deploy. Forward migration: skema baru. Backward migration: skema lama untuk rollback. Migration harus di-test sebelum deploy."]
            ],
quickCheck: {
                question: "Jelaskan blue-green dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan blue-green, canary, shadow, feature flag. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "7"
        ...
        {
hook: {
                question: "Monitoring Model dan Data tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimulai...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan monitoring model dan data dan k...", "Tentukan tujuan monitoring model dan data dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk latency serta error."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project API Prediksi dengan Canary Release, tim perlu menerapkan monitoring model dan dat",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["latency", "Waktu respons API model. P99 latency: 99% request selesai dalam X ms. Monitoring: average, P95, P99. Latency spike = indikasi masalah."],
                ["error", "Tingkat error model: prediction error rate, timeout rate, invalid input rate. Error budget: 'Kita toleransi 0.1% error rate per jam.' Jika terlampaui → stop deploy baru."],
                ["drift", "Perubahan distribusi data/model seiring waktu. Data drift: input distribution berubah. Concept drift: hubungan input-output berubah. Monitoring drift = trigger retraining."],
                ["quality", "Kualitas prediksi di produksi. Berbeda dari offline metrics — data produksi bisa sangat berbeda dari data training. Golden dataset: label manual untuk monitoring quality."],
                ["feedback", "Data aktual setelah prediksi: conversion (rekomendasi diklik), outcome (prediksi churn benar/salah). Feedback diperlukan untuk retraining dan evaluasi."],
                ["alert", "Notifikasi ketika metrik melampaui threshold: latency > 500ms, error rate > 1%, drift detected. On-call: orang yang menerima alert harus bisa response."]
            ],
quickCheck: {
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan latency, error, drift, quality. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "8"
    ...
    },
    {
        "id": "PRACTICE-2",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan serialization, dependency, image, registry. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-3",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan batch, online, stream, edge. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-4",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan server, worker, concurrency, GPU. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-5",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan schema, validation, status code, timeout. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-6",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan build, test, scan, deploy. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-7",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan blue-green, canary, shadow, feature flag. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-8",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan latency, error, drift, quality. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-9",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan batching, caching, quantization, throughput. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-10",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan authentication, authorization, rate limit, audit. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>AI Deployment</span><h3>Dari model ke produksi yang andal</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiDeploymentChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiDeploymentChallengeCh" + chapterNumber;
    ...
    window.loadAiDeploymentChapter = function (chapterNumber) {
    ...
    window.initAiDeploymentMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiDeploymentChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiDeploymentChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiDeploymentChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiDeploymentChapter(initial);
    };
    ...
    window.initAiDeploymentPractice = function () {
        const form = document.getElementById("aiDeploymentPracticeForm");
        const practiceList = document.getElementById("aiDeploymentPracticeList");
        if (!form || !practiceList) return;

        const refNode = document.getElementById("aiDeploymentPracticeSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiDeploymentPracticeNavigator");
        const counter = document.getElementById("aiDeploymentPracticeCounter");
        ...
        setStatus("#aiDeploymentPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiDeploymentPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiDeploymentPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiDeploymentPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiDeploymentPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiDeploymentQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiDeploymentQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiDeploymentQuizCounter");
        ...
        const next = document.getElementById("aiDeploymentQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiDeploymentQuiz = function () {
        const form = document.getElementById("aiDeploymentQuizForm");
        const list = document.getElementById("aiDeploymentQuizList");
        if (!form || !list) return;

        const refNode = document.getElementById("aiDeploymentQuizSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiDeploymentQuizNavigator");
        const counter = document.getElementById("aiDeploymentQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiDeploymentDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiDeploymentDiscussion = function () {
        const form = document.getElementById("aiDeploymentDiscussionForm");
        const select = form ? form.querySelector("select") : null;
        const textarea = form ? form.querySelector("textarea") : null;
        const refNode = document.getElementById("aiDeploymentDiscussionSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiDeploymentDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiDeploymentDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
