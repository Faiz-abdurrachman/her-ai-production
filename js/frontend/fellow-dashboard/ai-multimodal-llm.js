(function () {
    const STORAGE = {
        chapter: "heraiAiMultimodalLlmCurrentChapter",
        practice: "heraiAiMultimodalLlmPractice",
        quizDone: "heraiAiMultimodalLlmQuizDone",
        quizScore: "heraiAiMultimodalLlmQuizScore",
        quizAnswers: "heraiAiMultimodalLlmQuizAnswers",
        discussion: "heraiAiMultimodalLlmDiscussion",
    ...
    const MODULE_ID = 'multimodal-llm';
...
const CHAPTERS = [
    {
        "title": "Pengantar Multimodal Large Language Model",
        "shortTitle": "Pengantar Multimo...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Pengantar Multimodal Large Language Model",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/01-topic.html"
    },
    {
        "title": "Modalitas dan Representasi",
        "shortTitle": "Modalitas dan Rep...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Modalitas dan Representasi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/02-topic.html"
    },
    {
        "title": "Arsitektur Inti dan Strategi Fusion",
        "shortTitle": "Arsitektur Inti d...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Arsitektur Inti dan Strategi Fusion",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/03-topic.html"
    },
    {
        "title": "Tokenisasi, Alignment, dan Context Budget",
        "shortTitle": "Tokenisasi, Align...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Tokenisasi, Alignment, dan Context Budget",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/04-topic.html"
    },
    {
        "title": "Pretraining dan Multimodal Instruction Tuning",
        "shortTitle": "Pretraining dan M...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Pretraining dan Multimodal Instruction Tuning",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/05-topic.html"
    },
    {
        "title": "Multimodal Prompting dan Inference",
        "shortTitle": "Multimodal Prompt...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Multimodal Prompting dan Inference",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/06-topic.html"
    },
    {
        "title": "Multi-Image, Dokumen, Audio, dan Video",
        "shortTitle": "Multi-Image, Doku...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Multi-Image, Dokumen, Audio, dan Video",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/07-topic.html"
    },
    {
        "title": "Multimodal RAG dan Tool Use",
        "shortTitle": "Multimodal RAG da...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Multimodal RAG dan Tool Use",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/08-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/09-topic.html"
    },
    {
        "title": "Evaluasi Multimodal",
        "shortTitle": "Evaluasi Multimodal",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Evaluasi Multimodal",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/10-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/11-topic.html"
    },
    {
        "title": "Deployment, Optimasi, dan Monitoring",
        "shortTitle": "Deployment, Optim...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Deployment, Optimasi, dan Monitoring",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/12-topic.html"
    },
    {
        "title": "Mini Project: Asisten Operasional Multimodal",
        "shortTitle": "Mini Project: Asi...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: Asisten Operasional Multimodal",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/13-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/14-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/multimodal-llm/chapters/15-topic.html"
    }
];
...
hook: {
                ...
                message: "Modalitas adalah bentuk atau saluran informasi. Teks, gambar, audio, video, tabel, data sensor, dan posisi geografis dapat dianggap sebagai modalitas karena masing-masing memiliki struktur data dan cara interpretasi yang berbeda.\n\nContoh:"
            },
flow: [
...
challenge: {
                instruction: "modalitas yang tersedia,",
...
roadmapRef: "1"
        ...
        {
hook: {
                question: "Representasi sebagai Jembatan",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
                ...
                message: "Model tidak menerima makna secara langsung. Setiap input perlu diubah menjadi tensor atau embedding. Representasi yang baik mempertahankan informasi yang penting bagi tugas dan mengurangi bagian yang tidak relevan.\n\n``text\nData mentah -> preprocessing -> encoder -> embedding / token\n``"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
deepDive: [
                ["Komponen Dasar", "Komponen Dasar\n\nMLLM dapat terdiri dari beberapa komponen berikut:", "- encoder per modalitas,\n- tokenizer atau feature extractor,\n- projector atau connector,\n- fusion module,\n- language model,\n- decoder khusus modalitas,\n- tool router,\n- memory atau retrieval system.\n\nTidak semua sistem memakai seluruh komponen. Arsitektur dipilih sesuai tugas, data, dan batas komputasi."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Komponen Dasar\n\nMLLM dapat terdiri dari beberapa komponen berikut:\n\n- encoder per modalitas,\n- tokenizer atau feature extractor,\n- projector atau connector,\n- fusion module,\n- language model,\n- decoder khusus modalitas,\n- tool router,\n- memory atau retrieval system.\n\nTidak semua sistem memakai selur"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa perbedaan fungsi encoder dan projector?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
hook: {
                ...
                message: "MLLM sering mengubah informasi non-teks menjadi urutan token laten. Token tersebut bukan kata, melainkan vektor yang mewakili bagian atau ringkasan data.\n\nContoh:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
quickCheck: {
                question: "Mengapa contrastive objective tidak cukup untuk instruction following?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
roadmapRef: "5"
        ...
        {
hook: {
                question: "Prompt sebagai Kontrak",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
...
roadmapRef: "6"
        ...
        {
hook: {
                question: "Multi-Image Reasoning",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
...
roadmapRef: "7"
        ...
        {
hook: {
                question: "Mengapa Multimodal RAG?",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
                ...
                message: "Retrieval-Augmented Generation menambahkan informasi eksternal yang relevan saat inference. Pada multimodal RAG, item yang diambil dapat berupa teks, gambar, halaman dokumen, audio clip, video segment, atau data terstruktur.\n\nTujuan:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
deepDive: [
                ["Mengapa Multimodal RAG?", "Mengapa Multimodal RAG?\n\nRetrieval-Augmented Generation menambahkan informasi eksternal yang relevan saat inference. Pada multimodal RAG, item yang diambil dapat berupa teks, gambar, halaman dokumen, audio clip, video segment, atau data terstruktur.", "Tujuan:\n\n- mengurangi context overload,\n- menjaga informasi tetap mutakhir,\n- menyediakan bukti,\n- membatasi data yang dikirim ke model,\n- meningkatkan kemampuan domain."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Mengapa Multimodal RAG?\n\nRetrieval-Augmented Generation menambahkan informasi eksternal yang relevan saat inference. Pada multimodal RAG, item yang diambil dapat berupa teks, gambar, halaman dokumen, audio clip, video segment, atau data terstruktur.\n\nTujuan:\n\n- mengurangi context overload,\n- menjaga"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa perbedaan unimodal dan cross-modal retrieval?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>Multimodal LLM</span><h3>AI yang memahami teks, gambar, dan suara</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiMultimodalLlmChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiMultimodalLlmChallengeCh" + chapterNumber;
    ...
    window.loadAiMultimodalLlmChapter = function (chapterNumber) {
    ...
    window.initAiMultimodalLlmMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiMultimodalLlmChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiMultimodalLlmChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiMultimodalLlmChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiMultimodalLlmChapter(initial);
    };
    ...
    window.initAiMultimodalLlmPractice = function () {
        const form = document.getElementById("aiMultimodalLlmPracticeForm");
        ...
        const navigator = document.getElementById("aiMultimodalLlmPracticeNavigator");
        const counter = document.getElementById("aiMultimodalLlmPracticeCounter");
        ...
        setStatus("#aiMultimodalLlmPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiMultimodalLlmPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiMultimodalLlmPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiMultimodalLlmPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiMultimodalLlmPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiMultimodalLlmQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiMultimodalLlmQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiMultimodalLlmQuizCounter");
        ...
        const next = document.getElementById("aiMultimodalLlmQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiMultimodalLlmQuiz = function () {
        const form = document.getElementById("aiMultimodalLlmQuizForm");
        ...
        const navigator = document.getElementById("aiMultimodalLlmQuizNavigator");
        const counter = document.getElementById("aiMultimodalLlmQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiMultimodalLlmDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiMultimodalLlmDiscussion = function () {
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiMultimodalLlmDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiMultimodalLlmDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
