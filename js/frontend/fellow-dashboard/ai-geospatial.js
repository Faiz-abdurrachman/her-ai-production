(function () {
    const STORAGE = {
        chapter: "heraiAiGeospatialCurrentChapter",
        practice: "heraiAiGeospatialPractice",
        quizDone: "heraiAiGeospatialQuizDone",
        quizScore: "heraiAiGeospatialQuizScore",
        quizAnswers: "heraiAiGeospatialQuizAnswers",
        discussion: "heraiAiGeospatialDiscussion",
        readiness: "heraiAiGeospatialReadiness"
    };
...
const CHAPTERS = [
    {
        "title": "Spatial Thinking dan Pertanyaan Lokasi",
        "shortTitle": "Spatial Thinking ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Spatial Thinking dan Pertanyaan Lokasi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/01-topic.html"
    },
    {
        "title": "Vector, Raster, dan Coordinate Reference System",
        "shortTitle": "Vector, Raster, d...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Vector, Raster, dan Coordinate Reference System",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/02-topic.html"
    },
    {
        "title": "Sumber Data dan Remote Sensing",
        "shortTitle": "Sumber Data dan R...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Sumber Data dan Remote Sensing",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/03-topic.html"
    },
    {
        "title": "Preprocessing Data Geospasial",
        "shortTitle": "Preprocessing Dat...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Preprocessing Data Geospasial",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/04-topic.html"
    },
    {
        "title": "Spatial Feature Engineering",
        "shortTitle": "Spatial Feature E...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Spatial Feature Engineering",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/05-topic.html"
    },
    {
        "title": "Spatial Machine Learning dan Validation",
        "shortTitle": "Spatial Machine L...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Spatial Machine Learning dan Validation",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/06-topic.html"
    },
    {
        "title": "Computer Vision untuk Earth Observation",
        "shortTitle": "Computer Vision u...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Computer Vision untuk Earth Observation",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/07-topic.html"
    },
    {
        "title": "Spatiotemporal Forecasting",
        "shortTitle": "Spatiotemporal Fo...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Spatiotemporal Forecasting",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/08-topic.html"
    },
    {
        "title": "Uncertainty, Ethics, dan Location Privacy",
        "shortTitle": "Uncertainty, Ethi...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Uncertainty, Ethics, dan Location Privacy",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/09-topic.html"
    },
    {
        "title": "Web Maps, Deployment, dan Monitoring",
        "shortTitle": "Web Maps, Deploym...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Web Maps, Deployment, dan Monitoring",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/10-topic.html"
    },
    {
        "title": "Mini Project: Prioritas Risiko Banjir Berbasis Wilayah",
        "shortTitle": "Mini Project: Pri...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: Prioritas Risiko Banjir Berbasis Wilayah",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/11-topic.html"
    },
    {
        "title": "Kuis Akhir",
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/12-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/13-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/14-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/geospatial/chapters/15-topic.html"
    }
];
    ...
    const PYTHON_GUIDES = [
        {
hook: {
                question: "Spatial Thinking dan Pertanyaan Lokasi tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik s...",
                answerA: {
                    label: "Mitos umum",
                ...
                message: "Analogi: Data geospasial seperti cerita yang terikat tempat: memindahkan titik atau memakai sistem koordinat yang salah dapat mengubah makna, walaupun angka lainnya terlihat benar.\n\nPada praktiknya, kualitas bukan hanya berarti hasil tampak benar. Kualitas juga mencakup konsistensi, keterlacakan, ke"
            },
flow: [
                ["Tentukan tujuan spatial thinking dan pertanyaan...", "Tentukan tujuan spatial thinking dan pertanyaan lokasi dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk location serta distance."],
...
workedExample: [
                "Dalam mini project Prioritas Risiko Banjir Berbasis Wilayah, tim perlu menerapkan spatial thinking d",
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan location, distance, neighborhood, scale. Tandai asumsi dan titik kegagalan.",
...
roadmapRef: "1"
        ...
        {
hook: {
                question: "Vector, Raster, dan Coordinate Reference System tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan ya...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan vector, raster, dan coordinate ...", "Tentukan tujuan vector, raster, dan coordinate reference system dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk point serta line."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prioritas Risiko Banjir Berbasis Wilayah, tim perlu menerapkan vector, raster, da",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan point, line, polygon, raster. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "2"
        ...
        {
hook: {
                question: "Sumber Data dan Remote Sensing tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu di...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan sumber data dan remote sensing ...", "Tentukan tujuan sumber data dan remote sensing dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk survey serta GPS."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prioritas Risiko Banjir Berbasis Wilayah, tim perlu menerapkan sumber data dan re",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan survey, GPS, satellite, drone. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "3"
        ...
        {
hook: {
                question: "Preprocessing Data Geospasial tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dim...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan preprocessing data geospasial d...", "Tentukan tujuan preprocessing data geospasial dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk reprojection serta clipping."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prioritas Risiko Banjir Berbasis Wilayah, tim perlu menerapkan preprocessing data",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan reprojection, clipping, resampling, geocoding. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "4"
        ...
        {
hook: {
                question: "Spatial Feature Engineering tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimul...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan spatial feature engineering dan...", "Tentukan tujuan spatial feature engineering dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk buffer serta distance."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prioritas Risiko Banjir Berbasis Wilayah, tim perlu menerapkan spatial feature en",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan buffer, distance, density, zonal statistic. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "5"
        ...
        {
hook: {
                question: "Spatial Machine Learning dan Validation tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik ...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan spatial machine learning dan va...", "Tentukan tujuan spatial machine learning dan validation dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk spatial split serta autocorrelation."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prioritas Risiko Banjir Berbasis Wilayah, tim perlu menerapkan spatial machine le",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan spatial split, autocorrelation, leakage, imbalance. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "6"
        ...
        {
hook: {
                question: "Computer Vision untuk Earth Observation tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik ...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan computer vision untuk earth obs...", "Tentukan tujuan computer vision untuk earth observation dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
...
workedExample: [
                "Dalam mini project Prioritas Risiko Banjir Berbasis Wilayah, tim perlu menerapkan computer vision un",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan classification, detection, segmentation, change detection. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "7"
        ...
        {
hook: {
                question: "Spatiotemporal Forecasting tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimula...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan spatiotemporal forecasting dan ...", "Tentukan tujuan spatiotemporal forecasting dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk time series serta grid."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prioritas Risiko Banjir Berbasis Wilayah, tim perlu menerapkan spatiotemporal for",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan time series, grid, mobility, weather. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "8"
    ...
    },
    {
        "id": "PRACTICE-2",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan point, line, polygon, raster. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-3",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan survey, GPS, satellite, drone. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-4",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan reprojection, clipping, resampling, geocoding. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-5",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan buffer, distance, density, zonal statistic. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-6",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan spatial split, autocorrelation, leakage, imbalance. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-7",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan classification, detection, segmentation, change detection. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-8",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan time series, grid, mobility, weather. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-9",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan uncertainty, aggregation, re-identification, bias. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-10",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan tile, API, map layer, cache. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>AI + Geospasial</span><h3>Memahami bumi melalui data dan AI</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiGeospatialChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiGeospatialChallengeCh" + chapterNumber;
    ...
    window.loadAiGeospatialChapter = function (chapterNumber) {
    ...
    window.initAiGeospatialMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiGeospatialChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiGeospatialChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiGeospatialChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiGeospatialChapter(initial);
    };
    ...
    window.initAiGeospatialPractice = function () {
        const form = document.getElementById("aiGeospatialPracticeForm");
        const practiceList = document.getElementById("aiGeospatialPracticeList");
        if (!form || !practiceList) return;

        const refNode = document.getElementById("aiGeospatialPracticeSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiGeospatialPracticeNavigator");
        const counter = document.getElementById("aiGeospatialPracticeCounter");
        ...
        setStatus("#aiGeospatialPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiGeospatialPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiGeospatialPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiGeospatialPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiGeospatialPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiGeospatialQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiGeospatialQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiGeospatialQuizCounter");
        ...
        const next = document.getElementById("aiGeospatialQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiGeospatialQuiz = function () {
        const form = document.getElementById("aiGeospatialQuizForm");
        const list = document.getElementById("aiGeospatialQuizList");
        if (!form || !list) return;

        const refNode = document.getElementById("aiGeospatialQuizSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiGeospatialQuizNavigator");
        const counter = document.getElementById("aiGeospatialQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiGeospatialDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiGeospatialDiscussion = function () {
        const form = document.getElementById("aiGeospatialDiscussionForm");
        const select = form ? form.querySelector("select") : null;
        const textarea = form ? form.querySelector("textarea") : null;
        const refNode = document.getElementById("aiGeospatialDiscussionSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiGeospatialDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiGeospatialDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
