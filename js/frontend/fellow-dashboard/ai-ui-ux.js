(function () {
    const STORAGE = {
        chapter: "heraiAiUiUxCurrentChapter",
        practice: "heraiAiUiUxPractice",
        quizDone: "heraiAiUiUxQuizDone",
        quizScore: "heraiAiUiUxQuizScore",
        quizAnswers: "heraiAiUiUxQuizAnswers",
        discussion: "heraiAiUiUxDiscussion",
        readiness: "heraiAiUiUxReadiness"
    };
...
const CHAPTERS = [
    {
        "title": "Human-Centered Design dan Design Thinking",
        "shortTitle": "Human-Centered De...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Human-Centered Design dan Design Thinking",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/01-topic.html"
    },
    {
        "title": "Empathize dan User Research",
        "shortTitle": "Empathize dan Use...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Empathize dan User Research",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/02-topic.html"
    },
    {
        "title": "Define, Persona, dan Journey",
        "shortTitle": "Define, Persona, ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Define, Persona, dan Journey",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/03-topic.html"
    },
    {
        "title": "Ideate dan Prioritization",
        "shortTitle": "Ideate dan Priori...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Ideate dan Prioritization",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/04-topic.html"
    },
    {
        "title": "Information Architecture dan User Flow",
        "shortTitle": "Information Archi...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Information Architecture dan User Flow",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/05-topic.html"
    },
    {
        "title": "Wireframe dan Prototyping",
        "shortTitle": "Wireframe dan Pro...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Wireframe dan Prototyping",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/06-topic.html"
    },
    {
        "title": "Usability Testing dan Synthesis",
        "shortTitle": "Usability Testing...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Usability Testing dan Synthesis",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/07-topic.html"
    },
    {
        "title": "Visual Design dan Design System",
        "shortTitle": "Visual Design dan...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Visual Design dan Design System",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/08-topic.html"
    },
    {
        "title": "AI UX: Trust, Uncertainty, dan Control",
        "shortTitle": "AI UX: Trust, Unc...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai AI UX: Trust, Uncertainty, dan Control",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/09-topic.html"
    },
    {
        "title": "Accessibility, Inclusive Design, dan Iterasi",
        "shortTitle": "Accessibility, In...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Accessibility, Inclusive Design, dan Iterasi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/10-topic.html"
    },
    {
        "title": "Mini Project: Web Evaluasi Diri dan Potensi",
        "shortTitle": "Mini Project: Web...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: Web Evaluasi Diri dan Potensi",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/11-topic.html"
    },
    {
        "title": "Kuis Akhir",
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/12-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/13-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/14-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/business-industry-applications/ui-ux/chapters/15-topic.html"
    }
];
...
roadmapRef: "8"
    ...
    },
    {
        "id": "PRACTICE-2",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan interview, observation, survey, behavior. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-3",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan problem statement, persona, journey, pain point. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-4",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan divergence, convergence, idea, impact. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-5",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan content, hierarchy, navigation, task flow. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-6",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan fidelity, wireframe, prototype, interaction. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-7",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan task, participant, observation, severity. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-8",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan typography, color, spacing, component. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-9",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan expectation, confidence, citation, correction. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-10",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan keyboard, contrast, language, disability. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
...
var SOURCE_VISUALS = {
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiUiUxChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiUiUxChallengeCh" + chapterNumber;
    ...
    window.loadAiUiUxChapter = function (chapterNumber) {
    ...
    window.initAiUiUxMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiUiUxChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiUiUxChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiUiUxChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiUiUxChapter(initial);
    };
    ...
    window.initAiUiUxPractice = function () {
        const form = document.getElementById("aiUiUxPracticeForm");
        const practiceList = document.getElementById("aiUiUxPracticeList");
        if (!form || !practiceList) return;

        const refNode = document.getElementById("aiUiUxPracticeSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiUiUxPracticeNavigator");
        const counter = document.getElementById("aiUiUxPracticeCounter");
        ...
        setStatus("#aiUiUxPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiUiUxPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiUiUxPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiUiUxPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiUiUxPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiUiUxQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiUiUxQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiUiUxQuizCounter");
        ...
        const next = document.getElementById("aiUiUxQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiUiUxQuiz = function () {
        const form = document.getElementById("aiUiUxQuizForm");
        const list = document.getElementById("aiUiUxQuizList");
        if (!form || !list) return;

        const refNode = document.getElementById("aiUiUxQuizSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiUiUxQuizNavigator");
        const counter = document.getElementById("aiUiUxQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiUiUxDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiUiUxDiscussion = function () {
        const form = document.getElementById("aiUiUxDiscussionForm");
        const select = form ? form.querySelector("select") : null;
        const textarea = form ? form.querySelector("textarea") : null;
        const refNode = document.getElementById("aiUiUxDiscussionSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiUiUxDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiUiUxDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
