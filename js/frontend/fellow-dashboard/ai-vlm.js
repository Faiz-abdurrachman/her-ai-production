(function () {
    const STORAGE = {
        chapter: "heraiAiVlmCurrentChapter",
        practice: "heraiAiVlmPractice",
        quizDone: "heraiAiVlmQuizDone",
        quizScore: "heraiAiVlmQuizScore",
        quizAnswers: "heraiAiVlmQuizAnswers",
        discussion: "heraiAiVlmDiscussion",
...
const CHAPTERS = [
    {
        "title": "Pengantar Vision Language Model",
        "shortTitle": "Pengantar Vision ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Pengantar Vision Language Model",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/01-topic.html"
    },
    {
        "title": "Dari Gambar Menjadi Representasi Numerik",
        "shortTitle": "Dari Gambar Menja...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Dari Gambar Menjadi Representasi Numerik",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/02-topic.html"
    },
    {
        "title": "Representasi Bahasa dalam Sistem Multimodal",
        "shortTitle": "Representasi Baha...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Representasi Bahasa dalam Sistem Multimodal",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/03-topic.html"
    },
    {
        "title": "Menyelaraskan Gambar dan Teks",
        "shortTitle": "Menyelaraskan Gam...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Menyelaraskan Gambar dan Teks",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/04-topic.html"
    },
    {
        "title": "Pola Arsitektur Vision Language Model",
        "shortTitle": "Pola Arsitektur V...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Pola Arsitektur Vision Language Model",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/05-topic.html"
    },
    {
        "title": "Data dan Proses Pembelajaran Multimodal",
        "shortTitle": "Data dan Proses P...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Data dan Proses Pembelajaran Multimodal",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/06-topic.html"
    },
    {
        "title": "Tugas Utama Vision Language Model",
        "shortTitle": "Tugas Utama Visio...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Tugas Utama Vision Language Model",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/07-topic.html"
    },
    {
        "title": "Visual Prompting dan Inference",
        "shortTitle": "Visual Prompting ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Visual Prompting dan Inference",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/08-topic.html"
    },
    {
        "title": "Adaptasi dan Fine-Tuning",
        "shortTitle": "Adaptasi dan Fine...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Adaptasi dan Fine-Tuning",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/09-topic.html"
    },
    {
        "title": "Evaluasi Vision Language Model",
        "shortTitle": "Evaluasi Vision L...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Evaluasi Vision Language Model",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/10-topic.html"
    },
    {
        "title": "Hallucination, Bias, Privacy, dan Safety",
        "shortTitle": "Hallucination, Bi...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Hallucination, Bias, Privacy, dan Safety",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/11-topic.html"
    },
    {
        "title": "Deployment dan Monitoring",
        "shortTitle": "Deployment dan Mo...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Deployment dan Monitoring",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/12-topic.html"
    },
    {
        "title": "Mini Project: Asisten Analisis Gambar",
        "shortTitle": "Mini Project: Asi...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: Asisten Analisis Gambar",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/13-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/14-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/generative-multimodal-ai/vlm/chapters/15-topic.html"
    }
];
    ...
    const PYTHON_GUIDES = [
        {
hook: {
                question: "Apa Itu Vision Language Model?",
                answerA: {
                    label: "Mitos",
                ...
                message: "Vision Language Model adalah model AI yang dapat menghubungkan informasi visual dengan bahasa. Input dapat berupa satu gambar, beberapa gambar, teks, atau kombinasi gambar dan teks. Output umumnya berupa teks, skor kemiripan, label, koordinat, atau representasi bersama.\n\nContoh alur sederhana:"
            },
flow: [
...
challenge: {
                instruction: "input yang tersedia,",
...
roadmapRef: "1"
        ...
        {
hook: {
                question: "Gambar sebagai Tensor",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
                ...
                message: "Gambar digital dapat direpresentasikan sebagai tensor dengan tinggi, lebar, dan channel warna.\n\n``text\nGambar RGB berukuran 224 x 224\n-> tensor dengan bentuk [224, 224, 3]\n``"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
deepDive: [
                ["Gambar sebagai Tensor", "Gambar sebagai Tensor\n\nGambar digital dapat direpresentasikan sebagai tensor dengan tinggi, lebar, dan channel warna.", "```text\nGambar RGB berukuran 224 x 224\n-> tensor dengan bentuk [224, 224, 3]\n```\n\nNilai piksel umumnya berada pada rentang 0 sampai 255, kemudian dinormalisasi ke rentang tertentu. Model tidak melihat apel, meja, atau tulisan secara langsung. Model menerima pola angka yang kemudian diubah menjadi fitur."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Gambar sebagai Tensor\n\nGambar digital dapat direpresentasikan sebagai tensor dengan tinggi, lebar, dan channel warna.\n\n```text\nGambar RGB berukuran 224 x 224\n-> tensor dengan bentuk [224, 224, 3]\n```\n\nNilai piksel umumnya berada pada rentang 0 sampai 255, kemudian dinormalisasi ke rentang tertentu. "]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Mengapa gambar harus diproses sebelum masuk ke model?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
hook: {
                ...
                message: "Sama seperti LLM, sisi bahasa pada VLM menerima token ID. Tokenizer memecah instruksi, pertanyaan, label, atau caption menjadi unit yang dapat diproses model.\n\n``text\n\"Apa warna kendaraan itu?\"\n          |\n          v\n[\"Apa\", \" warna\", \" kendaraan\", \" itu\", \"?\"]\n          |\n          v\n[token_id_1, token_id_2, ...]\n``"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
deepDive: [
                ["Tokenisasi Teks", "Tokenisasi Teks\n\nSama seperti LLM, sisi bahasa pada VLM menerima token ID. Tokenizer memecah instruksi, pertanyaan, label, atau caption menjadi unit yang dapat diproses model.", "```text\n\"Apa warna kendaraan itu?\"\n          |\n          v\n[\"Apa\", \" warna\", \" kendaraan\", \" itu\", \"?\"]\n          |\n          v\n[token_id_1, token_id_2, ...]\n```\n\nTokenisasi memengaruhi panjang konteks, biaya, dan cara istilah khusus direpresentasikan."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Tokenisasi Teks\n\nSama seperti LLM, sisi bahasa pada VLM menerima token ID. Tokenizer memecah instruksi, pertanyaan, label, atau caption menjadi unit yang dapat diproses model.\n\n```text\n\"Apa warna kendaraan itu?\"\n          |\n          v\n[\"Apa\", \" warna\", \" kendaraan\", \" itu\", \"?\"]\n          |\n       "]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa fungsi tokenizer pada VLM?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
roadmapRef: "3"
        ...
        {
hook: {
                question: "Masalah Image-Text Alignment",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
                ...
                message: "Agar model dapat menghubungkan gambar dengan bahasa, representasi visual dan teks harus berada dalam ruang yang dapat dibandingkan atau digabungkan.\n\nContoh pasangan:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
roadmapRef: "4"
        ...
        {
hook: {
                question: "Mengapa Ada Banyak Arsitektur?",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
                ...
                message: "Tugas image retrieval membutuhkan arsitektur berbeda dari sistem yang harus menghasilkan jawaban panjang. Beberapa pola mengutamakan efisiensi embedding, sementara pola lain mengutamakan interaksi detail dan kemampuan generatif.\n\nTiga pola umum:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
deepDive: [
                ["Mengapa Ada Banyak Arsitektur?", "Mengapa Ada Banyak Arsitektur?\n\nTugas image retrieval membutuhkan arsitektur berbeda dari sistem yang harus menghasilkan jawaban panjang. Beberapa pola mengutamakan efisiensi embedding, sementara pola lain mengutamakan interaksi detail dan kemampuan generatif.", "Tiga pola umum:\n\n1. dual encoder,\n2. fusion encoder atau cross-modal encoder,\n3. vision encoder yang dihubungkan ke language decoder."]
            ],
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Mengapa Ada Banyak Arsitektur?\n\nTugas image retrieval membutuhkan arsitektur berbeda dari sistem yang harus menghasilkan jawaban panjang. Beberapa pola mengutamakan efisiensi embedding, sementara pola lain mengutamakan interaksi detail dan kemampuan generatif.\n\nTiga pola umum:\n\n1. dual encoder,\n2. f"]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Mengapa dual encoder efisien untuk retrieval?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
hook: {
                ...
                message: "Text-to-image retrieval mencari gambar paling relevan untuk kueri teks. Image-to-text retrieval mencari caption atau dokumen yang cocok untuk gambar.\n\nPipeline:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
workedExample: [
                "Penerapan Konsep",
                ["Deskripsi", "Image-Text Retrieval\n\nText-to-image retrieval mencari gambar paling relevan untuk kueri teks. Image-to-text retrieval mencari caption atau dokumen yang cocok untuk gambar.\n\nPipeline:\n\n```text\nOffline:\nsemua gambar -> image encoder -> embeddings -> vector index\n\nOnline:\nkueri teks -> text encoder -> "]
            ],
glossary: [
                ["Konsep", "Definisi."]
            ],
quickCheck: {
                question: "Apa perbedaan captioning dan VQA?",
                options: ["Jawaban A", "Jawaban B", "Jawaban C"],
                answer: 0,
                explanationCorrect: "Tepat.",
                explanationWrong: "Coba pikirkan ulang."
...
roadmapRef: "7"
        ...
        {
hook: {
                question: "Struktur Prompt Visual",
                answerA: {
                    label: "Mitos",
                    text: "Jawaban umum yang perlu diluruskan.",
                    icon: "fas fa-times-circle"
                ...
                message: "Prompt yang baik menjelaskan tujuan dan batas bukti.\n\nTemplate dasar:"
            },
flow: [
                ["Persiapan", "Pelajari materi bab ini."],
                ["Eksekusi", "Praktikkan konsep yang dipelajari."],
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>Vision Language Model</span><h3>Penglihatan komputer dengan language model</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiVlmChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiVlmChallengeCh" + chapterNumber;
    ...
    window.loadAiVlmChapter = function (chapterNumber) {
    ...
    window.initAiVlmMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiVlmChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiVlmChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiVlmChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiVlmChapter(initial);
    };
    ...
    window.initAiVlmPractice = function () {
        const form = document.getElementById("aiVlmPracticeForm");
        ...
        const navigator = document.getElementById("aiVlmPracticeNavigator");
        const counter = document.getElementById("aiVlmPracticeCounter");
        ...
        setStatus("#aiVlmPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiVlmPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiVlmPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiVlmPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiVlmPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiVlmQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiVlmQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiVlmQuizCounter");
        ...
        const next = document.getElementById("aiVlmQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiVlmQuiz = function () {
        const form = document.getElementById("aiVlmQuizForm");
        ...
        const navigator = document.getElementById("aiVlmQuizNavigator");
        const counter = document.getElementById("aiVlmQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiVlmDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiVlmDiscussion = function () {
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiVlmDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiVlmDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
