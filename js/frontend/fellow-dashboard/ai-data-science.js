(function () {
    const STORAGE = {
        chapter: "heraiAiDataScienceCurrentChapter",
        practice: "heraiAiDataSciencePractice",
        quizDone: "heraiAiDataScienceQuizDone",
        quizScore: "heraiAiDataScienceQuizScore",
        quizAnswers: "heraiAiDataScienceQuizAnswers",
        discussion: "heraiAiDataScienceDiscussion",
        readiness: "heraiAiDataScienceReadiness"
    };
...
const CHAPTERS = [
    {
        "title": "Problem Framing dan Metrik Keberhasilan",
        "shortTitle": "Problem Framing d...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Problem Framing dan Metrik Keberhasilan",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/01-topic.html"
    },
    {
        "title": "Memahami Proses Pembentukan Data",
        "shortTitle": "Memahami Proses P...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Memahami Proses Pembentukan Data",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/02-topic.html"
    },
    {
        "title": "Exploratory Data Analysis",
        "shortTitle": "Exploratory Data ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Exploratory Data Analysis",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/03-topic.html"
    },
    {
        "title": "Pembersihan dan Preprocessing",
        "shortTitle": "Pembersihan dan P...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Pembersihan dan Preprocessing",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/04-topic.html"
    },
    {
        "title": "Feature Engineering dan Baseline",
        "shortTitle": "Feature Engineeri...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Feature Engineering dan Baseline",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/05-topic.html"
    },
    {
        "title": "Pemodelan dan Pemilihan Algoritma",
        "shortTitle": "Pemodelan dan Pem...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Pemodelan dan Pemilihan Algoritma",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/06-topic.html"
    },
    {
        "title": "Validasi, Eksperimen, dan Kausalitas",
        "shortTitle": "Validasi, Eksperi...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Validasi, Eksperimen, dan Kausalitas",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/07-topic.html"
    },
    {
        "title": "Interpretasi dan Komunikasi Hasil",
        "shortTitle": "Interpretasi dan ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Interpretasi dan Komunikasi Hasil",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/08-topic.html"
    },
    {
        "title": "Reproducibility dan Handoff",
        "shortTitle": "Reproducibility d...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Reproducibility dan Handoff",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/09-topic.html"
    },
    {
        "title": "Etika, Bias, dan Responsible Data Science",
        "shortTitle": "Etika, Bias, dan ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Etika, Bias, dan Responsible Data Science",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/10-topic.html"
    },
    {
        "title": "Mini Project: Prediksi Risiko Churn Pelanggan",
        "shortTitle": "Mini Project: Pre...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: Prediksi Risiko Churn Pelanggan",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/11-topic.html"
    },
    {
        "title": "Kuis Akhir",
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/12-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/13-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/14-topic.html"
    },
    {
        ...
        "sourcePath": "/pages/frontend/fellow-dashboard/data-engineering-domains/data-science/chapters/15-topic.html"
    }
];
    ...
    const PYTHON_GUIDES = [
        {
hook: {
                question: "Problem Framing dan Metrik Keberhasilan tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik ...",
                answerA: {
                    label: "Mitos umum",
                ...
                message: "Analogi: Data scientist seperti detektif ilmiah: menyusun pertanyaan, memeriksa kualitas bukti, menguji dugaan, lalu menjelaskan tingkat keyakinan dan keterbatasannya.\n\nPada praktiknya, kualitas bukan hanya berarti hasil tampak benar. Kualitas juga mencakup konsistensi, keterlacakan, keamanan, biaya"
            },
flow: [
                ["Tentukan tujuan problem framing dan metrik kebe...", "Tentukan tujuan problem framing dan metrik keberhasilan dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk tujuan serta keputusan."],
...
workedExample: [
                "Dalam mini project Prediksi Risiko Churn Pelanggan, tim perlu menerapkan problem framing dan metrik ",
...
glossary: [
                ["tujuan", "Pertanyaan bisnis yang ingin dijawab: 'Siapa yang akan churn?', 'Produk apa yang akan dibeli?'. Tujuan menentukan metrik, data, dan model yang digunakan."],
                ["keputusan", "Aksi yang akan diambil berdasarkan insight model: 'Kirim promo ke user dengan probabilitas churn > 70%'. Model tanpa keputusan = latihan akademis."],
                ["unit analisis", "Entitas yang dianalisis: per user, per transaksi, per produk. Unit analisis menentukan grain data. Pilih yang sesuai dengan keputusan yang akan diambil."],
                ["target", "Apa yang diprediksi: binary (churn/no churn), multiclass (segment A/B/C), continuous (revenue). Target harus observable dan measurable."],
                ["constraint", "Batasan yang harus dipenuhi: budget, timeline, regulasi, fairness. Model terbaik secara statistik belum tentu feasible secara operasional."],
                ["metric", "Cara mengukur keberhasilan model: akurasi, precision, recall, RMSE. Metrik harus relevan dengan tujuan — bukan sekadar yang paling mudah dihitung."]
            ],
quickCheck: {
                question: "Jelaskan tujuan dengan kalimat sendiri dan berikan satu contoh.",
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan tujuan, keputusan, unit analisis, target. Tandai asumsi dan titik kegagalan.",
...
roadmapRef: "1"
        ...
        {
hook: {
                question: "Memahami Proses Pembentukan Data tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu ...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan memahami proses pembentukan dat...", "Tentukan tujuan memahami proses pembentukan data dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk data generating process serta selection bias."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prediksi Risiko Churn Pelanggan, tim perlu menerapkan memahami proses pembentukan",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["data generating process", "Proses nyata yang menghasilkan data: bagaimana data lahir, siapa yang membuat, insentif apa yang mempengaruhi. Paham DGP = paham bias dan keterbatasan data."],
                ["selection bias", "Data tidak representatif karena cara pengumpulannya. Contoh: diagnosis hanya untuk pasien yang ke RS — pasien ringan (tidak ke RS) tidak terdata. Model belajar dari data yang bukan populasi sebenarnya."],
                ["label", "Nilai kebenaran (ground truth) yang diprediksi model. Label quality > label quantity. Gold standard label dari expert — silver standard dari heuristics."],
                ["leakage", "Informasi dari masa depan yang bocor ke data training. Contoh: menggunakan data setelah diagnosis untuk memprediksi diagnosis. Leakage = model seolah bagus, padahal curang."],
                ["missingness", "Data yang tidak tercatat. Missing Completely At Random (MCAR), Missing At Random (MAR), Missing Not At Random (MNAR). Strategi imputasi tergantung tipe missingness."],
                ["sampling", "Memilih subset data untuk analisis. Random sampling: setiap anggota punya probabilitas sama. Stratified: proporsi kelas dijaga. Sampling bukan hanya untuk efisiensi — bisa mengurangi bias."]
            ],
quickCheck: {
                question: "Jelaskan data generating process dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan data generating process, selection bias, label, leakage. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "2"
        ...
        {
hook: {
                question: "Exploratory Data Analysis tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimulai...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan exploratory data analysis dan k...", "Tentukan tujuan exploratory data analysis dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk distribusi serta outlier."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prediksi Risiko Churn Pelanggan, tim perlu menerapkan exploratory data analysis s",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["distribusi", "Penyebaran nilai dalam data. Histogram, boxplot, density plot. Normality: asumsi banyak model statistik. Skewness: distribusi menceng — perlu transformasi."],
                ["outlier", "Nilai yang jauh dari mayoritas data. Bisa berarti error (salah input, sensor rusak) atau insight (fraud, rare event). Jangan hapus outlier tanpa analisis."],
                ["korelasi", "Hubungan antara dua variabel: Pearson (linear), Spearman (monotonic). Korelasi ≠ kausalitas. Tapi korelasi adalah sinyal untuk investigasi lebih lanjut."],
                ["segmentasi", "Membagi data menjadi kelompok yang homogen: RFM segmentation, demographic clustering. Segmentasi memungkinkan strategi berbeda per grup."],
                ["visualisasi", "Mengubah data menjadi grafik: line (trend), bar (comparison), scatter (correlation), heatmap (matrix). Visualisasi yang baik mengungkap pattern yang tidak terlihat di tabel."],
                ["hipotesis", "Pernyataan awal yang bisa diuji dengan data. Null hypothesis (H0): tidak ada efek. Alternative hypothesis (H1): ada efek. Statistical test menentukan reject atau fail to reject H0."]
            ],
quickCheck: {
                question: "Jelaskan distribusi dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan distribusi, outlier, korelasi, segmentasi. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "3"
        ...
        {
hook: {
                question: "Pembersihan dan Preprocessing tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dim...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan pembersihan dan preprocessing d...", "Tentukan tujuan pembersihan dan preprocessing dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk imputation serta encoding."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prediksi Risiko Churn Pelanggan, tim perlu menerapkan pembersihan dan preprocessi",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["imputation", "Mengisi nilai yang hilang: mean, median (numerik), mode (kategorikal), forward fill (time series). Imputasi mengubah distribusi data — dokumentasikan."],
                ["encoding", "Mengubah data kategorikal ke numerik: one-hot encoding (tanpa order), label encoding (ordinal), target encoding (mean target per kategori). Pilihan encoding mempengaruhi model."],
                ["scaling", "Menyamakan skala numerik: MinMax (0-1), Standard (mean 0, std 1), Robust (based on IQR). Scaling penting untuk model berbasis jarak (KNN, SVM, PCA)."],
                ["duplicate", "Baris data yang identik. Exact duplicate: semua kolom sama. Partial duplicate: beberapa kolom sama (duplicate ID). Duplicate bias ke model — hapus sebelum training."],
                ["pipeline", "Urutan transformasi otomatis: impute → encode → scale → model. Pipeline mencegah data leakage — fitur ditransform dalam fold cross-validation."],
                ["split", "Membagi data menjadi training, validation, test. Typical: 70/15/15. Stratified split: proporsi kelas sama di semua split. Time split: data masa lalu = train, masa depan = test."]
            ],
quickCheck: {
                question: "Jelaskan imputation dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan imputation, encoding, scaling, duplicate. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "4"
        ...
        {
hook: {
                question: "Feature Engineering dan Baseline tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu ...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan feature engineering dan baselin...", "Tentukan tujuan feature engineering dan baseline dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk feature serta domain knowledge."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prediksi Risiko Churn Pelanggan, tim perlu menerapkan feature engineering dan bas",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["feature", "Variabel input yang dipakai model untuk prediksi: usia, saldo, frekuensi transaksi. Feature quality menentukan batas atas performa model."],
                ["domain knowledge", "Pengetahuan tentang bisnis/domain yang memandu feature engineering. Ahli domain bisa memberi feature yang tidak terlihat dari data mentah."],
                ["baseline", "Model sederhana sebagai pembanding: predict mean, logistic regression. Jika model kompleks tidak lebih baik dari baseline, return on investment negatif."],
                ["benchmark", "Standard industri untuk perbandingan: performa model kompetitor, academic papers, atau model sederhana. Benchmark harus fair — data dan metrik yang sama."],
                ["leakage", "Informasi dari masa depan atau dari target yang bocor ke feature. Paling umum: menggunakan data yang tidak tersedia saat prediksi. Cross-validation temporal mencegah leakage."],
                ["simplicity", "Model sederhana lebih baik dari kompleks jika performa sama. Lebih mudah debugging, interpretasi, maintenance. Occam's razor dalam ML."]
            ],
quickCheck: {
                question: "Jelaskan feature dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan feature, domain knowledge, baseline, benchmark. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "5"
        ...
        {
hook: {
                question: "Pemodelan dan Pemilihan Algoritma tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan pemodelan dan pemilihan algorit...", "Tentukan tujuan pemodelan dan pemilihan algoritma dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk regression serta classification."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prediksi Risiko Churn Pelanggan, tim perlu menerapkan pemodelan dan pemilihan alg",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["regression", "Memprediksi nilai kontinu: harga rumah, revenue, temperatur. Metrics: RMSE, MAE, R². Linear regression adalah baseline — hubungan linear antara feature dan target."],
                ["classification", "Memprediksi kategori: spam/not spam, churn/no churn. Metrics: accuracy, precision, recall, F1, AUC-ROC. Imbalanced class: fokus ke recall/precision bukan accuracy."],
                ["tree", "Decision tree: if-else rules yang dipelajari dari data. Interpretable, menangani non-linear. Rentan overfit — perlu pruning atau ensemble."],
                ["ensemble", "Menggabungkan banyak model: Random Forest (bagging trees), XGBoost (boosting trees). Ensemble > single model — mengurangi variance (bagging) atau bias (boosting)."],
                ["calibration", "Probabilitas model sesuai realita. Model calibrated: prediksi 70% → actual 70%. Platt scaling dan isotonic regression untuk post-hoc calibration."],
                ["trade-off", "Kompromi antar metrik: precision vs recall (threshold selection), bias vs variance (model complexity), interpretability vs accuracy (simple vs complex)."]
            ],
quickCheck: {
                question: "Jelaskan regression dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan regression, classification, tree, ensemble. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "6"
        ...
        {
hook: {
                question: "Validasi, Eksperimen, dan Kausalitas tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik sel...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan validasi, eksperimen, dan kausa...", "Tentukan tujuan validasi, eksperimen, dan kausalitas dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk cross-validation serta time split."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prediksi Risiko Churn Pelanggan, tim perlu menerapkan validasi, eksperimen, dan k",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["cross-validation", "Membagi data menjadi K fold, train di K-1, test di 1, ulangi K kali. K-Fold CV: estimasi performa yang stabil. Stratified CV: proporsi kelas sama per fold."],
                ["time split", "Cross-validation yang menghormati urutan waktu. Train: data sebelum tanggal X. Test: data setelah X. Mencegah lookahead bias — hanya test dengan data masa depan."],
                ["A/B test", "Eksperimen: kontrol vs treatment, random assignment. Metrics: conversion rate, average order value. Durasi: cukup untuk statistical significance. Stop early only jika efek sangat besar atau tidak ada."],
                ["confounder", "Variabel yang mempengaruhi treatment dan outcome. Contoh: 'user usia muda (confounder) lebih sering pakai fitur baru (treatment) dan juga lebih loyal (outcome).' Koreksi: regression, matching, IPTW."],
                ["causal effect", "Dampak kausal dari treatment ke outcome — bukan sekadar korelasi. 'Apakah fitur baru menyebabkan retention naik?' Dijawab dengan eksperimen atau causal inference (DID, IV, RDD)."],
                ["power", "Probabilitas mendeteksi efek yang benar-benar ada (tidak false negative). Power 80%: 80% chance mendeteksi efek jika benar ada. Power tergantung: sample size, effect size, significance level."]
            ],
quickCheck: {
                question: "Jelaskan cross-validation dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan cross-validation, time split, A/B test, confounder. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "7"
        ...
        {
hook: {
                question: "Interpretasi dan Komunikasi Hasil tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan interpretasi dan komunikasi has...", "Tentukan tujuan interpretasi dan komunikasi hasil dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk feature importance serta SHAP."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project Prediksi Risiko Churn Pelanggan, tim perlu menerapkan interpretasi dan komunikasi",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["feature importance", "Seberapa besar setiap feature berkontribusi ke prediksi model. Tree: gain/impurity reduction. Permutation importance: observasi metrik turun saat feature di-randomize."],
                ["SHAP", "SHapley Additive exPlanations — nilai kontribusi setiap feature per prediksi. 'Kenapa user A diprediksi churn? Karena saldo rendah (-0.3) dan frekuensi login turun (-0.2).'"],
                ["uncertainty", "Model harus menyatakan ketidakpastian: prediction interval (regression), confidence (classification). Model yang overconfident berbahaya — seolah tahu padahal tidak."],
                ["narrative", "Cerita yang menjelaskan insight data. 'Churn naik 20% karena segmen A: user baru yang tidak menyelesaikan onboarding.' Narrative membuat insight bisa ditindaklanjuti."],
                ["visualization", "Grafik yang mengkomunikasikan hasil analisis: feature importance bar, SHAP summary plot, confusion matrix, ROC curve. Setiap visualisasi harus punya satu pesan utama."],
                ["recommendation", "Rekomendasi actionable berdasarkan hasil analisis: 'Kirim email onboarding ke user baru di hari 1-3', 'Naikkan threshold fraud detection 5%'. Analisis tanpa rekomendasi = latihan."]
            ],
quickCheck: {
                question: "Jelaskan feature importance dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan feature importance, SHAP, uncertainty, narrative. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "8"
    ...
    },
    {
        "id": "PRACTICE-2",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan data generating process, selection bias, label, leakage. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-3",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan distribusi, outlier, korelasi, segmentasi. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-4",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan imputation, encoding, scaling, duplicate. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-5",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan feature, domain knowledge, baseline, benchmark. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-6",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan regression, classification, tree, ensemble. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-7",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan cross-validation, time split, A/B test, confounder. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-8",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan feature importance, SHAP, uncertainty, narrative. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-9",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan environment, seed, versioning, experiment tracking. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
    ...
    },
    {
        "id": "PRACTICE-10",
        "title": "Latihan",
        "prompt": "1. Buat diagram sederhana yang menghubungkan fairness, proxy, privacy, harm. Tandai asumsi dan titik kegagalan.\n2. Tulis kriteria penerimaan untuk satu proses dalam bab ini. Sertakan kondisi normal, error, dan kasus batas.\n3. Pilih satu risiko dan buat kontrol preventif, kontrol detektif, serta prosedur respons.",
        "fields": [
            [
                "step",
                "Langkah Pengerjaan"
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>Data Science</span><h3>Eksplorasi, pemodelan, dan insight</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiDataScienceChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiDataScienceChallengeCh" + chapterNumber;
    ...
    window.loadAiDataScienceChapter = function (chapterNumber) {
    ...
    window.initAiDataScienceMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiDataScienceChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiDataScienceChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiDataScienceChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiDataScienceChapter(initial);
    };
    ...
    window.initAiDataSciencePractice = function () {
        const form = document.getElementById("aiDataSciencePracticeForm");
        const practiceList = document.getElementById("aiDataSciencePracticeList");
        if (!form || !practiceList) return;

        const refNode = document.getElementById("aiDataSciencePracticeSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiDataSciencePracticeNavigator");
        const counter = document.getElementById("aiDataSciencePracticeCounter");
        ...
        setStatus("#aiDataSciencePracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiDataSciencePracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiDataSciencePracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiDataSciencePracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiDataSciencePracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiDataScienceQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiDataScienceQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiDataScienceQuizCounter");
        ...
        const next = document.getElementById("aiDataScienceQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiDataScienceQuiz = function () {
        const form = document.getElementById("aiDataScienceQuizForm");
        const list = document.getElementById("aiDataScienceQuizList");
        if (!form || !list) return;

        const refNode = document.getElementById("aiDataScienceQuizSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        const navigator = document.getElementById("aiDataScienceQuizNavigator");
        const counter = document.getElementById("aiDataScienceQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiDataScienceDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiDataScienceDiscussion = function () {
        const form = document.getElementById("aiDataScienceDiscussionForm");
        const select = form ? form.querySelector("select") : null;
        const textarea = form ? form.querySelector("textarea") : null;
        const refNode = document.getElementById("aiDataScienceDiscussionSource"); if(refNode) refNode.innerHTML = "<div style='padding: 20px; text-align: center; color: var(--text-secondary);'>Baca ulang materi secara utuh di tab Materi utama.</div>";
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiDataScienceDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiDataScienceDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
