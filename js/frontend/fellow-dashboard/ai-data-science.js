...
glossary: [
                ["tujuan", "konsep penting dalam problem framing dan metrik keberhasilan yang perlu diberi definisi operasional sebelum dipakai"],
                ["keputusan", "konsep penting dalam problem framing dan metrik keberhasilan yang perlu diberi definisi operasional sebelum dipakai"],
                ["unit analisis", "konsep penting dalam problem framing dan metrik keberhasilan yang perlu diberi definisi operasional sebelum dipakai"],
                ["target", "konsep penting dalam problem framing dan metrik keberhasilan yang perlu diberi definisi operasional sebelum dipakai"],
                ["constraint", "konsep penting dalam problem framing dan metrik keberhasilan yang perlu diberi definisi operasional sebelum dipakai"],
...
glossary: [
                ["data generating process", "konsep penting dalam memahami proses pembentukan data yang perlu diberi definisi operasional sebelum dipakai"],
                ["selection bias", "konsep penting dalam memahami proses pembentukan data yang perlu diberi definisi operasional sebelum dipakai"],
                ["label", "konsep penting dalam memahami proses pembentukan data yang perlu diberi definisi operasional sebelum dipakai"],
                ["leakage", "konsep penting dalam memahami proses pembentukan data yang perlu diberi definisi operasional sebelum dipakai"],
                ["missingness", "konsep penting dalam memahami proses pembentukan data yang perlu diberi definisi operasional sebelum dipakai"],
                ["sampling", "konsep penting dalam memahami proses pembentukan data yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["distribusi", "konsep penting dalam exploratory data analysis yang perlu diberi definisi operasional sebelum dipakai"],
                ["outlier", "konsep penting dalam exploratory data analysis yang perlu diberi definisi operasional sebelum dipakai"],
                ["korelasi", "konsep penting dalam exploratory data analysis yang perlu diberi definisi operasional sebelum dipakai"],
                ["segmentasi", "konsep penting dalam exploratory data analysis yang perlu diberi definisi operasional sebelum dipakai"],
                ["visualisasi", "konsep penting dalam exploratory data analysis yang perlu diberi definisi operasional sebelum dipakai"],
                ["hipotesis", "konsep penting dalam exploratory data analysis yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["imputation", "konsep penting dalam pembersihan dan preprocessing yang perlu diberi definisi operasional sebelum dipakai"],
                ["encoding", "konsep penting dalam pembersihan dan preprocessing yang perlu diberi definisi operasional sebelum dipakai"],
                ["scaling", "konsep penting dalam pembersihan dan preprocessing yang perlu diberi definisi operasional sebelum dipakai"],
                ["duplicate", "konsep penting dalam pembersihan dan preprocessing yang perlu diberi definisi operasional sebelum dipakai"],
                ["pipeline", "konsep penting dalam pembersihan dan preprocessing yang perlu diberi definisi operasional sebelum dipakai"],
                ["split", "konsep penting dalam pembersihan dan preprocessing yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ...
                ["domain knowledge", "konsep penting dalam feature engineering dan baseline yang perlu diberi definisi operasional sebelum dipakai"],
                ["baseline", "pendekatan sederhana sebagai pembanding minimum"],
                ["benchmark", "konsep penting dalam feature engineering dan baseline yang perlu diberi definisi operasional sebelum dipakai"],
                ["leakage", "konsep penting dalam feature engineering dan baseline yang perlu diberi definisi operasional sebelum dipakai"],
                ["simplicity", "konsep penting dalam feature engineering dan baseline yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["regression", "konsep penting dalam pemodelan dan pemilihan algoritma yang perlu diberi definisi operasional sebelum dipakai"],
                ["classification", "konsep penting dalam pemodelan dan pemilihan algoritma yang perlu diberi definisi operasional sebelum dipakai"],
                ["tree", "konsep penting dalam pemodelan dan pemilihan algoritma yang perlu diberi definisi operasional sebelum dipakai"],
                ["ensemble", "konsep penting dalam pemodelan dan pemilihan algoritma yang perlu diberi definisi operasional sebelum dipakai"],
                ["calibration", "kesesuaian antara skor probabilitas dan frekuensi kejadian nyata"],
                ["trade-off", "konsep penting dalam pemodelan dan pemilihan algoritma yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["cross-validation", "konsep penting dalam validasi, eksperimen, dan kausalitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["time split", "konsep penting dalam validasi, eksperimen, dan kausalitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["A/B test", "konsep penting dalam validasi, eksperimen, dan kausalitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["confounder", "konsep penting dalam validasi, eksperimen, dan kausalitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["causal effect", "konsep penting dalam validasi, eksperimen, dan kausalitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["power", "konsep penting dalam validasi, eksperimen, dan kausalitas yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["feature importance", "konsep penting dalam interpretasi dan komunikasi hasil yang perlu diberi definisi operasional sebelum dipakai"],
                ["SHAP", "konsep penting dalam interpretasi dan komunikasi hasil yang perlu diberi definisi operasional sebelum dipakai"],
                ["uncertainty", "tingkat ketidakpastian yang perlu ditampilkan dan dikelola"],
                ["narrative", "konsep penting dalam interpretasi dan komunikasi hasil yang perlu diberi definisi operasional sebelum dipakai"],
                ["visualization", "konsep penting dalam interpretasi dan komunikasi hasil yang perlu diberi definisi operasional sebelum dipakai"],
                ["recommendation", "konsep penting dalam interpretasi dan komunikasi hasil yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
var SOURCE_VISUALS = {
    ...
    function renderOrientationAndNav(module, chapterNum, total) {
        ...
        var navHtml = '<nav class="reasoning-source-jumps reasoning-visual-nav ai-modern-learning-nav" data-python-injected id="reasoning-visual-nav" aria-label="Tahapan ' + chapterNum + ' dari ' + total + '">' +
