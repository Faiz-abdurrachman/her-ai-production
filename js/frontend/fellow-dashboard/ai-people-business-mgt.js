(function () {
    const STORAGE = {
        chapter: "heraiAiPeopleBusinessMgtCurrentChapter",
        practice: "heraiAiPeopleBusinessMgtPractice",
        quizDone: "heraiAiPeopleBusinessMgtQuizDone",
        quizScore: "heraiAiPeopleBusinessMgtQuizScore",
        quizAnswers: "heraiAiPeopleBusinessMgtQuizAnswers",
        discussion: "heraiAiPeopleBusinessMgtDiscussion",
    ...
    const MODULE_ID = 'people-business-mgt';
...
const CHAPTERS = [
    {
        "title": "Strategi dan Penciptaan Nilai",
        "shortTitle": "Strategi dan Penc...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Strategi dan Penciptaan Nilai",
        "objectives": [
    ...
    },
    {
        ...
        "shortTitle": "Operating Model d...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Operating Model dan RACI",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    },
    {
        ...
        "shortTitle": "OKR, KPI, dan Gua...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai OKR, KPI, dan Guardrail",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    },
    {
        ...
        "shortTitle": "Prioritization da...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Prioritization dan Portfolio",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    },
    {
        ...
        "shortTitle": "Project, Product,...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Project, Product, dan Delivery Management",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    },
    {
        ...
        "shortTitle": "Komunikasi, Feedb...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Komunikasi, Feedback, dan Konflik",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    },
    {
        ...
        "shortTitle": "Capability Buildi...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Capability Building dan Talent",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    },
    {
        ...
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Change Management dan Adoption",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    },
    {
        ...
        "shortTitle": "AI Governance dan...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai AI Governance dan Risk Management",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    },
    {
        ...
        "shortTitle": "Finance, Stakehol...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Finance, Stakeholder, dan Value Realization",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    },
    {
        ...
        "shortTitle": "Mini Project: AI ...",
        "duration": "20 menit",
        "icon": "fas fa-brain",
        "summary": "Materi mengenai Mini Project: AI Initiative Operating Plan",
        "objectives": [
            "Memahami konsep dasar",
            "Mampu mengidentifikasi penggunaan praktis"
        ],
    ...
    const PYTHON_GUIDES = [
        {
hook: {
                question: "Strategi dan Penciptaan Nilai tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dim...",
                answerA: {
                    label: "Mitos umum",
                ...
                message: "Analogi: Manajemen seperti mengarahkan orkestra: setiap pemain dapat ahli, tetapi hasil hanya harmonis ketika tujuan, peran, tempo, komunikasi, dan mekanisme koreksi disepakati.\n\nPada praktiknya, kualitas bukan hanya berarti hasil tampak benar. Kualitas juga mencakup konsistensi, keterlacakan, keama"
            },
flow: [
                ["Tentukan tujuan strategi dan penciptaan nilai d...", "Tentukan tujuan strategi dan penciptaan nilai dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk strategy serta customer value."],
...
workedExample: [
                "Dalam mini project AI Initiative Operating Plan, tim perlu menerapkan strategi dan penciptaan nilai ",
...
glossary: [
                ["strategy", "Rencana jangka panjang untuk mencapai keunggulan kompetitif: pasar mana yang akan digarap, nilai apa yang ditawarkan, sumber daya apa yang dibutuhkan. Strategi menjawab 'mengapa pelanggan memilih kita'."],
                ["customer value", "Nilai unik yang diberikan ke pelanggan: produk lebih baik, harga lebih murah, layanan lebih cepat. Value proposition harus jelas, terukur, dan sulit ditiru kompetitor."],
                ["capability", "Kemampuan internal yang membedakan perusahaan: teknologi proprietary, budaya inovasi, jaringan distribusi. Strategi harus dibangun di atas capability — jangan mengejar sesuatu yang tidak bisa dieksekusi."],
                ["advantage", "Keunggulan kompetitif yang sustainable: biaya lebih rendah, brand lebih kuat, data lebih kaya. Keunggulan yang mudah ditiru = bukan keunggulan jangka panjang."],
                ["outcome", "Hasil strategis yang ingin dicapai: market share #1, NPS > 70, revenue growth 20% per tahun. Outcome mengukur apakah strategi berhasil — bukan seberapa sibuk tim."],
                ["trade-off", "Memilih satu hal dengan mengorbankan yang lain: harga murah vs kualitas tinggi, kecepatan vs fitur lengkap. Strategic trade-off: 'Kita tidak akan menjadi yang terbaik di segalanya.'"]
            ],
quickCheck: {
                question: "Jelaskan strategy dengan kalimat sendiri dan berikan satu contoh.",
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan strategy, customer value, capability, advantage. Tandai asumsi dan titik kegagalan.",
...
roadmapRef: "1"
        ...
        {
hook: {
                question: "Operating Model dan RACI tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimulai ...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan operating model dan raci dan ke...", "Tentukan tujuan operating model dan raci dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk structure serta role."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project AI Initiative Operating Plan, tim perlu menerapkan operating model dan raci secar",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["structure", "Cara perusahaan diorganisir: fungsional (marketing, produk, tech), divisi (produk A, B, C), matrix (campuran). Struktur harus mendukung strategi — struktur yang salah menghambat eksekusi."],
                ["role", "Tanggung jawab spesifik dalam organisasi: apa yang dikerjakan, keputusan apa yang bisa diambil, siapa yang menjadi atasan/bawahan. Role clarity = tidak ada pekerjaan yang 'dianggap dikerjakan orang lain'."],
                ["accountability", "Seseorang yang bertanggung jawab atas hasil — bukan hanya aktivitas. 'Siapa yang accountable untuk revenue growth?' Harus satu orang, bukan tim."],
                ["RACI", "Matrix: Responsible (mengerjakan), Accountable (memutuskan), Consulted (dimintai input), Informed (diberi tahu). Menghilangkan kebingungan: 'Saya kira dia yang mengerjakan'."],
                ["decision right", "Wewenang mengambil keputusan pada setiap level: keputusan operational oleh tim, taktical oleh manajer, strategis oleh C-level. Decision right yang jelas = organisasi tidak lambat."],
                ["cadence", "Jadwal review dan koordinasi: daily standup (tim), weekly sync (antar tim), monthly review (manajemen), quarterly planning (strategis). Setiap level punya cadence berbeda."]
            ],
quickCheck: {
                question: "Jelaskan structure dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan structure, role, accountability, RACI. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "2"
        ...
        {
hook: {
                question: "OKR, KPI, dan Guardrail tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimulai d...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan okr, kpi, dan guardrail dan kep...", "Tentukan tujuan okr, kpi, dan guardrail dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk objective serta key result."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project AI Initiative Operating Plan, tim perlu menerapkan okr, kpi, dan guardrail secara",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["objective", "Tujuan strategis yang ingin dicapai: 'Menjadi platform edukasi AI nomor 1 di Indonesia'. Objective bersifat aspiratif dan inspiratif — bukan sekadar angka."],
                ["key result", "Ukuran keberhasilan objektif: 'Market share 30%', 'NPS > 70', 'Revenue 100M/bulan'. Key result HARUS terukur — 'brand awareness meningkat' itu sentiment, bukan key result."],
                ["KPI", "Key Performance Indicator — metrik yang dipantau secara kontinu: conversion rate, churn, customer acquisition cost. KPI berbeda dari Key Result: KPI bersifat ongoing, Key Result untuk periode tertentu."],
                ["target", "Nilai spesifik yang ingin dicapai di KPI: 'Conversion rate: 5%', 'Churn: <3%'. Target tanpa baseline = tidak berguna — tidak tahu apakah bagus atau buruk."],
                ["guardrail", "Batas yang tidak boleh dilanggar saat mengejar target: 'Customer satisfaction minimal 4.0'. Jangan korbankan CSAT demi conversion rate — itu jangka pendek."],
                ["review", "Proses periodik mengevaluasi progress terhadap target: weekly check-in, monthly review, quarterly business review. Review harus menghasilkan action, bukan sekadar laporan."]
            ],
quickCheck: {
                question: "Jelaskan objective dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan objective, key result, KPI, target. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "3"
        ...
        {
hook: {
                question: "Prioritization dan Portfolio tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu dimu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan prioritization dan portfolio da...", "Tentukan tujuan prioritization dan portfolio dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk impact serta effort."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project AI Initiative Operating Plan, tim perlu menerapkan prioritization dan portfolio s",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["impact", "Besarnya pengaruh jika inisiatif berhasil: revenue increase, cost saving, efficiency gain. Impact diukur dalam angka — Rp, %, jam yang dihemat."],
                ["effort", "Sumber daya yang dibutuhkan: people (jam/orang), waktu (minggu/bulan), biaya, dan risiko. Effort estimation harus realistis — optimism bias adalah jebakan klasik."],
                ["risk", "Ketidakpastian yang bisa mempengaruhi keberhasilan: teknis (tidak bisa dibangun), market (tidak ada yang mau beli), timeline (molor). Setiap inisiatif harus di-risk-assess."],
                ["dependency", "Inisiatif yang harus selesai sebelum inisiatif lain bisa dimulai. 'Project B depends on Project A selesai dulu.' Dependency chain: satu delay = cascade delay."],
                ["portfolio", "Kumpulan inisiatif yang dikelola bersama: balance antara high-risk/high-reward (innovation) dan low-risk/steady (core business). Portofolio = strategi investasi resource."],
                ["sequencing", "Urutan mengerjakan inisiatif: mana yang duluan? Priority matrix: impact vs effort. Quick wins (high impact, low effort) dikerjakan duluan."]
            ],
quickCheck: {
                question: "Jelaskan impact dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan impact, effort, risk, dependency. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "4"
        ...
        {
hook: {
                question: "Project, Product, dan Delivery Management tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang bai...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan project, product, dan delivery ...", "Tentukan tujuan project, product, dan delivery management dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk scope serta roadmap."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project AI Initiative Operating Plan, tim perlu menerapkan project, product, dan delivery",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["scope", "Fitur dan fungsionalitas yang termasuk dalam satu project/timeline. Scope creep: tambahan di tengah jalan yang mengancam deadline. Scope lock: setelah disepakati, perubahan = project baru."],
                ["roadmap", "Rencana jangka panjang: fitur/project apa yang akan dikerjakan dalam 1-4 quarter. Roadmap bukan janji — ini adalah 'current best thinking' yang bisa berubah."],
                ["backlog", "Daftar pekerjaan yang menunggu dikerjakan, diprioritaskan berdasarkan impact, effort, dan dependency. Product owner yang memprioritaskan backlog — bukan engineering."],
                ["milestone", "Titik signifikan dalam timeline: 'Beta launch selesai', 'Testing dengan 1000 user', 'Full launch'. Milestone adalah check-in point — sudah sejauh mana kita?"],
                ["iteration", "Siklus pengembangan pendek: 1-2 minggu. Setiap iteration menghasilkan sesuatu yang bisa diuji. Iteration pendek = feedback cepat = tidak banyak buang waktu di fitur yang salah."],
                ["acceptance", "Kriteria yang harus dipenuhi agar fitur dianggap selesai: 'User bisa login dengan Google', 'Response time < 2 detik'. Acceptance criteria ditulis SEBELUM coding dimulai."]
            ],
quickCheck: {
                question: "Jelaskan scope dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan scope, roadmap, backlog, milestone. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "5"
        ...
        {
hook: {
                question: "Komunikasi, Feedback, dan Konflik tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan komunikasi, feedback, dan konfl...", "Tentukan tujuan komunikasi, feedback, dan konflik dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk stakeholder serta feedback."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project AI Initiative Operating Plan, tim perlu menerapkan komunikasi, feedback, dan konf",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["stakeholder", "Pihak dengan kepentingan dalam project: sponsor, user, tim teknis, regulator, tim legal. Setiap stakeholder perlu di-manage: ada yang perlu dilibatkan, ada yang cukup diinformasikan."],
                ["feedback", "Masukan dari stakeholder tentang hasil kerja. Feedback yang baik: spesifik, behavioral, actionable. 'Saya tidak suka' — itu opini, bukan feedback. 'Button CTA terlalu kecil di mobile' — itu feedback."],
                ["negotiation", "Diskusi untuk mencapai kesepakatan ketika ada perbedaan kepentingan: 'Fitur A vs B — kita cuma bisa kerjakan satu.' Negosiasi yang baik: win-win, bukan kompromi yang merugikan semua."],
                ["conflict", "Perbedaan pendapat yang tidak terselesaikan. Konflik tidak selalu buruk — konflik tentang IDE bisa menghasilkan solusi lebih baik. Konflik PERSONAL beracun — bedakan."],
                ["escalation", "Melibatkan atasan/level lebih tinggi ketika konflik tidak bisa diselesaikan di level tim. Eskalasi harus disertai: masalah, opsi yang sudah dicoba, rekomendasi."],
                ["psychological safety", "Lingkungan di mana anggota tim merasa aman mengambil risiko: mengakui kesalahan, bertanya 'tolong jelaskan lagi', menantang ide atasan. Ini adalah prediktor #1 tim berkinerja tinggi."]
            ],
quickCheck: {
                question: "Jelaskan stakeholder dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan stakeholder, feedback, negotiation, conflict. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "6"
        ...
        {
hook: {
                question: "Capability Building dan Talent tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu di...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan capability building dan talent ...", "Tentukan tujuan capability building dan talent dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk skill serta role."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project AI Initiative Operating Plan, tim perlu menerapkan capability building dan talent",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["skill", "Kemampuan spesifik yang dibutuhkan organisasi: technical (programming, data analysis) dan soft (communication, leadership). Skill gap analysis: kompetensi yang dimiliki vs dibutuhkan."],
                ["role", "Posisi yang mengkombinasikan beberapa skill: 'Data Scientist' butuh statistik, programming, domain knowledge, dan komunikasi. Role description: skill apa yang essential vs nice-to-have."],
                ["hiring", "Proses rekrutmen: sourcing, screening, interview, offer. Hiring yang baik: berbasis kompetensi (bisa tes skill), bukan hanya intuisi. Structured interview lebih valid dari unstructured."],
                ["learning", "Pengembangan kompetensi existing employee: training, mentorship, rotation program, conference. Belajar adalah investasi — hitung ROI seperti investasi lain."],
                ["coaching", "Pendampingan individu oleh atasan/mentor untuk mencapai potensi maksimal. Bukan memberi jawaban — membantu orang menemukan jawabannya sendiri."],
                ["community", "Komunitas internal untuk berbagi pengetahuan: chapter, guild, special interest group. Komunitas mempercepat learning dan memecah silo antar tim."]
            ],
quickCheck: {
                question: "Jelaskan skill dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan skill, role, hiring, learning. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "7"
        ...
        {
hook: {
                question: "Change Management dan Adoption tidak berdiri sendiri. Bagian ini menghubungkan kebutuhan pengguna, proses kerja, data atau sumber daya, serta hasil yang akan dinilai. Pendekatan yang baik selalu di...",
                answerA: {
                    label: "Mitos umum",
                    text: "Anggapan yang sering muncul tapi perlu diklarifikasi.",
                    icon: "fas fa-question-circle"
...
flow: [
                ["Tentukan tujuan change management dan adoption ...", "Tentukan tujuan change management dan adoption dan keputusan yang akan dipengaruhi."],
                ["Petakan input, output, pemilik, pengguna, serta...", "Petakan input, output, pemilik, pengguna, serta batas sistem."],
                ["Tetapkan definisi dan kriteria penerimaan untuk...", "Tetapkan definisi dan kriteria penerimaan untuk readiness serta sponsor."],
                ["Bangun versi kecil menggunakan data atau skenar...", "Bangun versi kecil menggunakan data atau skenario yang aman."],
                ["Uji hasil, kegagalan, kelompok khusus, dan kond...", "Uji hasil, kegagalan, kelompok khusus, dan kondisi ekstrem."],
                ["Dokumentasikan keputusan, bukti, keterbatasan, ...", "Dokumentasikan keputusan, bukti, keterbatasan, serta tindak lanjut."]
            ],
...
workedExample: [
                "Dalam mini project AI Initiative Operating Plan, tim perlu menerapkan change management dan adoption",
                ["Data atau input belum lengkap", "Tolak, minta perbaikan, atau gunakan fallback"],
                ["Hasil belum pasti", "Tampilkan ketidakpastian dan minta review"],
                ["Beban meningkat", "Scale, antrekan, atau pembatasan"],
                ["Perubahan berisiko", "Uji terbatas dan siapkan rollback"]
...
glossary: [
                ["readiness", "Kesiapan organisasi terhadap perubahan: awareness (paham kenapa berubah), desire (mau berubah), knowledge (tahu caranya), ability (bisa melakukannya), reinforcement (diperkuat sistem)."],
                ["sponsor", "Pemimpin yang secara aktif mendukung perubahan: menyediakan resource, menghilangkan hambatan, memberi contoh. Sponsor bukan sekadar 'setuju' — sponsor harus terlihat dan terlibat."],
                ["champion", "Anggota tim yang menjadi advokat perubahan di level peers. Champion lebih dipercaya dari manajemen — mereka 'teman' yang sudah membuktikan."],
                ["training", "Program pembelajaran formal: workshop, online course, certification. Training harus memiliki learning objective yang jelas — 'peserta bisa melakukan X setelah training'."],
                ["incentive", "Reward dan punishment yang memotivasi perubahan: bonus untuk adopter awal, pengakuan publik, konsekuensi untuk penolakan. Incentive harus selaras dengan perilaku yang diinginkan."],
                ["adoption", "Tingkat penggunaan aktual sistem/proses baru setelah diluncurkan: 'Dari 100 user, 60 sudah menggunakan fitur baru — adoption rate 60%.' Target bukan peluncuran — target ADOPSI oleh pengguna."]
            ],
quickCheck: {
                question: "Jelaskan readiness dengan kalimat sendiri dan berikan satu contoh.",
                options: ["Jawaban A (belum tentu tepat)", "Jawaban B (belum tentu tepat)", "Jawaban C (belum tentu tepat)"],
                answer: 1,
                explanationCorrect: "Tepat. Pemahaman ini penting untuk materi selanjutnya.",
                explanationWrong: "Coba pikirkan ulang — hubungkan dengan konsep yang sudah dipelajari."
...
challenge: {
                instruction: "Buat diagram sederhana yang menghubungkan readiness, sponsor, champion, training. Tandai asumsi dan titik kegagalan.",
                placeholder: "Tulis jawaban Anda di sini...",
                example: ""
            },
roadmapRef: "8"
...
var SOURCE_VISUALS = {
    ...
    function renderPythonDeepDive(module) {
        ...
        if (module.deepDive && module.deepDive.length) {
            var roadmapHtml = '<section class="ai-modern-beginner-roadmap" data-python-injected data-section="konsep">' +
                '<div class="ai-modern-roadmap-head"><i class="fas fa-compass" aria-hidden="true"></i><div><span>People & Business</span><h3>Mengelola tim dan bisnis berbasis data</h3><p>Gunakan penjelasan berikut untuk menghubungkan kode, data, failure case, dan keputusan dalam workflow AI.</p></div></div>' +
    ...
    function finalRenderChallengeSection(challenge, chapterNumber) {
        var key = 'heraiAiPeopleBusinessMgtChallengeCh' + chapterNumber;
    ...
    function renderChallengeSection(challenge, chapterNumber) {
        var storageKey = "heraiAiPeopleBusinessMgtChallengeCh" + chapterNumber;
    ...
    window.loadAiPeopleBusinessMgtChapter = function (chapterNumber) {
    ...
    window.initAiPeopleBusinessMgtMateri = function () {
        ...
        if (list) {
            list.innerHTML = CHAPTERS.map(function (chapter, index) {
                ...
                return `<li data-chapter="${chapterNumber}"><span>${chapterNumber}</span><a href="javascript:void(0)" onclick="window.loadAiPeopleBusinessMgtChapter(${chapterNumber})">${escapeHtml(chapter.shortTitle)}</a><i class="far fa-circle"></i></li>`;
            }).join("");
        }
        ...
        if (btnPrev) {
            btnPrev.addEventListener("click", function () {
                ...
                window.loadAiPeopleBusinessMgtChapter(Math.max(1, current - 1));
            });
        }
        ...
        if (btnNext) {
            btnNext.addEventListener("click", function () {
                const current = Number(localStorage.getItem(STORAGE.chapter)) || initial;
                window.loadAiPeopleBusinessMgtChapter(Math.min(total, current + 1));
            });
        }

        window.loadAiPeopleBusinessMgtChapter(initial);
    };
    ...
    window.initAiPeopleBusinessMgtPractice = function () {
        const form = document.getElementById("aiPeopleBusinessMgtPracticeForm");
        ...
        const navigator = document.getElementById("aiPeopleBusinessMgtPracticeNavigator");
        const counter = document.getElementById("aiPeopleBusinessMgtPracticeCounter");
        ...
        setStatus("#aiPeopleBusinessMgtPracticeStatus", Object.keys(savedAnswers).length ? "Jawaban latihan dipulihkan dari browsermu." : "Jawaban akan tersimpan di browser ini.", Object.keys(savedAnswers).length ? "success" : "neutral");
        ...
        form.querySelectorAll("[data-reasoning-reveal]").forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                setStatus("#aiPeopleBusinessMgtPracticeStatus", "Pembahasan dan jawaban tersimpan di browser ini.", "success");
            });
        });
...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                setStatus("#aiPeopleBusinessMgtPracticeStatus", "Mode edit aktif. Simpan ulang setelah mengubah jawaban.", "neutral");
            });
        }
        ...
        if (resetButton) {
            resetButton.addEventListener("click", function () {
                ...
                setStatus("#aiPeopleBusinessMgtPracticeStatus", "Jawaban latihan direset dari browser ini.", "warning");
            });
        }
    };
    ...
    function renderQuizResult(score, total, message) {
        const result = document.getElementById("aiPeopleBusinessMgtQuizResult");
        if (!result) return;
    ...
    function lockQuiz(form, answers) {
        ...
        var qnav = document.getElementById("aiPeopleBusinessMgtQuizNavigator");
        var qprev = form.querySelector("[data-quiz-prev]");
        var qnext = form.querySelector("[data-quiz-next]");
        var qcounter = document.getElementById("aiPeopleBusinessMgtQuizCounter");
        ...
        const next = document.getElementById("aiPeopleBusinessMgtQuizNext");
        if (next) next.classList.remove("is-disabled");
    }

    window.initAiPeopleBusinessMgtQuiz = function () {
        const form = document.getElementById("aiPeopleBusinessMgtQuizForm");
        ...
        const navigator = document.getElementById("aiPeopleBusinessMgtQuizNavigator");
        const counter = document.getElementById("aiPeopleBusinessMgtQuizCounter");
    ...
    function renderDiscussion(posts) {
        const list = document.getElementById("aiPeopleBusinessMgtDiscussionList");
        if (!list) return;
        if (!posts.length) {
    ...
    window.initAiPeopleBusinessMgtDiscussion = function () {
        ...
        form.addEventListener("submit", function (event) {
            ...
            if (!text) {
                setStatus("#aiPeopleBusinessMgtDiscussionStatus", "Tulis isi diskusi terlebih dahulu.", "warning");
                return;
            }
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiPeopleBusinessMgtDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
