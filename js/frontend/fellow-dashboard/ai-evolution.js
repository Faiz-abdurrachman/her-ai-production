...
savePracticePayload({ answers: collectPracticeAnswers(form), revealed: revealed });
                ...
                setStatus("#aiEvolutionPracticeStatus", "Latihan Python tersimpan. Kamu bisa lanjut ke kuis atau edit lagi bila perlu.", "success");
            });
        }
    ...
    window.initAiEvolutionDiscussion = function () {
        ...
        form.addEventListener("submit", function (event) {
            ...
            saveDiscussionPosts(posts);
            form.reset();
            setStatus("#aiEvolutionDiscussionStatus", "Diskusi berhasil diposting dan tersimpan di browser ini.", "success");
            renderDiscussion(posts);
        });
    };
})();
