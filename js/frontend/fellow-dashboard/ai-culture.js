...
glossary: [
                ["community", "konsep penting dalam konteks budaya dan intended use yang perlu diberi definisi operasional sebelum dipakai"],
                ["context", "konsep penting dalam konteks budaya dan intended use yang perlu diberi definisi operasional sebelum dipakai"],
                ["intended use", "tujuan, pengguna, konteks, dan batas penggunaan yang dinyatakan"],
                ["stakeholder", "konsep penting dalam konteks budaya dan intended use yang perlu diberi definisi operasional sebelum dipakai"],
                ["benefit", "konsep penting dalam konteks budaya dan intended use yang perlu diberi definisi operasional sebelum dipakai"],
                ["harm", "konsep penting dalam konteks budaya dan intended use yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["capture", "konsep penting dalam digitization dan preservasi digital yang perlu diberi definisi operasional sebelum dipakai"],
                ["resolution", "konsep penting dalam digitization dan preservasi digital yang perlu diberi definisi operasional sebelum dipakai"],
                ["format", "konsep penting dalam digitization dan preservasi digital yang perlu diberi definisi operasional sebelum dipakai"],
                ["checksum", "konsep penting dalam digitization dan preservasi digital yang perlu diberi definisi operasional sebelum dipakai"],
                ["backup", "konsep penting dalam digitization dan preservasi digital yang perlu diberi definisi operasional sebelum dipakai"],
                ["preservation", "konsep penting dalam digitization dan preservasi digital yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["metadata", "konsep penting dalam metadata, taksonomi, dan ontologi yang perlu diberi definisi operasional sebelum dipakai"],
                ["vocabulary", "konsep penting dalam metadata, taksonomi, dan ontologi yang perlu diberi definisi operasional sebelum dipakai"],
                ...
                ["multilingual", "konsep penting dalam metadata, taksonomi, dan ontologi yang perlu diberi definisi operasional sebelum dipakai"],
...
glossary: [
                ["OCR", "konsep penting dalam nlp untuk bahasa dan naskah lokal yang perlu diberi definisi operasional sebelum dipakai"],
                ["transcription", "konsep penting dalam nlp untuk bahasa dan naskah lokal yang perlu diberi definisi operasional sebelum dipakai"],
                ["translation", "konsep penting dalam nlp untuk bahasa dan naskah lokal yang perlu diberi definisi operasional sebelum dipakai"],
                ["low-resource", "konsep penting dalam nlp untuk bahasa dan naskah lokal yang perlu diberi definisi operasional sebelum dipakai"],
                ["dialect", "konsep penting dalam nlp untuk bahasa dan naskah lokal yang perlu diberi definisi operasional sebelum dipakai"],
                ["annotation", "konsep penting dalam nlp untuk bahasa dan naskah lokal yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["classification", "konsep penting dalam computer vision untuk artefak yang perlu diberi definisi operasional sebelum dipakai"],
                ["detection", "konsep penting dalam computer vision untuk artefak yang perlu diberi definisi operasional sebelum dipakai"],
                ["similarity", "konsep penting dalam computer vision untuk artefak yang perlu diberi definisi operasional sebelum dipakai"],
                ["restoration", "konsep penting dalam computer vision untuk artefak yang perlu diberi definisi operasional sebelum dipakai"],
                ["condition", "konsep penting dalam computer vision untuk artefak yang perlu diberi definisi operasional sebelum dipakai"],
                ["provenance", "informasi asal, versi, pemilik, dan riwayat sebuah artefak"]
            ],
quickCheck: {
...
glossary: [
                ...
                ["recommendation", "konsep penting dalam recommendation dan cultural discovery yang perlu diberi definisi operasional sebelum dipakai"],
                ["diversity", "konsep penting dalam recommendation dan cultural discovery yang perlu diberi definisi operasional sebelum dipakai"],
                ["serendipity", "konsep penting dalam recommendation dan cultural discovery yang perlu diberi definisi operasional sebelum dipakai"],
                ["filter bubble", "konsep penting dalam recommendation dan cultural discovery yang perlu diberi definisi operasional sebelum dipakai"],
                ["explanation", "konsep penting dalam recommendation dan cultural discovery yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["generation", "konsep penting dalam generative ai dan kreativitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["co-creation", "konsep penting dalam generative ai dan kreativitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["style", "konsep penting dalam generative ai dan kreativitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["attribution", "konsep penting dalam generative ai dan kreativitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["consent", "konsep penting dalam generative ai dan kreativitas yang perlu diberi definisi operasional sebelum dipakai"],
                ["disclosure", "konsep penting dalam generative ai dan kreativitas yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
...
glossary: [
                ["participation", "konsep penting dalam partisipasi komunitas dan citizen curation yang perlu diberi definisi operasional sebelum dipakai"],
                ["validation", "konsep penting dalam partisipasi komunitas dan citizen curation yang perlu diberi definisi operasional sebelum dipakai"],
                ["correction", "konsep penting dalam partisipasi komunitas dan citizen curation yang perlu diberi definisi operasional sebelum dipakai"],
                ["benefit sharing", "konsep penting dalam partisipasi komunitas dan citizen curation yang perlu diberi definisi operasional sebelum dipakai"],
                ["moderation", "konsep penting dalam partisipasi komunitas dan citizen curation yang perlu diberi definisi operasional sebelum dipakai"],
                ["governance", "konsep penting dalam partisipasi komunitas dan citizen curation yang perlu diberi definisi operasional sebelum dipakai"]
            ],
quickCheck: {
