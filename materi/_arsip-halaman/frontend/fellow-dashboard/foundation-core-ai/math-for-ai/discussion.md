...
````html
<section class="fellow-dashboard fellow-modules-page lesson-detail-page math-ai-course-page" data-fellow-page="modules">
...
<nav class="lesson-breadcrumb" aria-label="Breadcrumb diskusi">
<a href="#/participant-ai-lab-math"><i class="fas fa-arrow-left"></i><span>Math for AI</span></a>
...
<div id="mathAiDiscussionContent"></div>
</article>
<aside class="lesson-right-panel">
<div id="mathAiDiscussionPanel"></div>
</aside>
</div>
</main>
</section>
