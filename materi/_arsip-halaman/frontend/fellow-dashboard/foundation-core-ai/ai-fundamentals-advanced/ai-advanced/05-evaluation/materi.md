...
````html
<section class="fellow-dashboard fellow-modules-page lesson-detail-page reasoning-scaffold-page ai-evaluation-page" data-fellow-page="modules">
    ...
    <main class="fellow-main ai-evaluation-shell">
        ...
        <div id="aiEvaluationApp" class="ai-evaluation-app" aria-live="polite">
            <section class="ai-evaluation-loading">
                <i class="fas fa-spinner fa-spin" aria-hidden="true"></i>
                <p>Memuat materi Evaluation AI...</p>
            </section>
        </div>
    </main>
</section>
