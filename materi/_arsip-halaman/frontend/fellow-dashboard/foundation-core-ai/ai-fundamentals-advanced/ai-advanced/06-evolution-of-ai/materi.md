...
````html
<section class="fellow-dashboard fellow-modules-page lesson-detail-page reasoning-scaffold-page ai-evolution-page" data-fellow-page="modules">
    ...
    <main class="fellow-main ai-evolution-shell">
        ...
        <div id="aiEvolutionApp" class="ai-evolution-app" aria-live="polite">
            <section class="ai-evolution-loading">
                <i class="fas fa-spinner fa-spin" aria-hidden="true"></i>
                <p>Memuat materi Evolution of AI...</p>
            </section>
        </div>
    </main>
</section>
