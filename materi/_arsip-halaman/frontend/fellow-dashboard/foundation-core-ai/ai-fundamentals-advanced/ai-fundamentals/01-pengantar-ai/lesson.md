...
> Sumber: `pages/frontend/fellow-dashboard/foundation-core-ai/ai-fundamentals-advanced/ai-fundamentals/01-pengantar-ai/lesson.html`
...
````html
<section class="fellow-dashboard fellow-modules-page lesson-detail-page ai-generated-lesson-page" data-fellow-page="modules">
    ...
    <main class="fellow-main">
        <header class="lesson-topbar">
            <nav class="lesson-breadcrumb" aria-label="Breadcrumb materi">
                ...
                <span data-lesson-breadcrumb>Materi</span>
            </nav>
        ...
        <div class="lesson-layout">
            <div class="lesson-main-content">
                <section class="lesson-hero">
                    <div class="lesson-hero-copy">
                        <h1 data-lesson-title>Materi AI</h1>
                        <p data-lesson-description></p>
                        <div class="lesson-meta-row"><span><i class="far fa-clock"></i> <span data-lesson-duration>35 menit</span></span><span><i class="fas fa-book-open"></i> <span data-lesson-position>Modul</span></span><b data-lesson-tag>Dasar</b></div>
                    </div>
                ...
                <section class="lesson-material-panel">
                    ...
                    <article class="lesson-article" data-lesson-content></article>
                    <footer class="lesson-nav-footer">
                        <a data-lesson-prev href="#/participant-ai-intro"><i class="fas fa-chevron-left"></i> Sebelumnya</a>
                        <a data-lesson-next href="#/participant-ai-fundamentals">Selanjutnya <i class="fas fa-arrow-right"></i></a>
                    </footer>
                </section>
            </div>
            <aside class="lesson-right-panel">
                <section class="module-side-card lesson-progress-card">
                    <h2>Progres Modul</h2>
                    <div class="lesson-progress-mini"><b data-lesson-progress-bar style="--value:16%"></b><strong data-lesson-progress-text>16%</strong></div>
                    <p data-lesson-progress-caption>Materi Pengantar AI</p>
                    <a href="#/participant-ai-intro-quiz">Kuis Modul</a>
                </section>
                ...
                <section class="module-side-card lesson-note-card lesson-compact-note">
                    <div class="module-side-head"><h2>Referensi</h2></div>
                    <p>World Travel & Tourism Council. <em>Introduction to Artificial Intelligence (AI) Technology</em>, January 2024.</p>
                </section>
            </aside>
        </div>
    </main>
