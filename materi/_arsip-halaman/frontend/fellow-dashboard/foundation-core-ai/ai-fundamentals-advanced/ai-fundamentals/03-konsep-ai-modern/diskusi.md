...
````html
<section class="fellow-dashboard fellow-modules-page lesson-detail-page reasoning-scaffold-page ai-modern-page ai-modern-discussion-page" data-fellow-page="modules">
    ...
    <main class="fellow-main">
        <header class="lesson-topbar">
            <nav class="lesson-breadcrumb" aria-label="Breadcrumb materi">
                <a href="#/participant-ai-modern-quiz"><i class="fas fa-arrow-left"></i><span>Kuis AI Modern</span></a>
        ...
        <div class="lesson-layout">
            <div class="lesson-main-content">
                <section class="lesson-hero compact">
                    <div class="lesson-hero-copy">
                        <h1>Diskusi Konsep AI Modern</h1>
                        <p>Diskusikan trade-off foundation model, context, agent autonomy, dan sistem AI fellowship yang aman dioperasikan.</p>
                        <div class="lesson-meta-row"><span><i class="far fa-message"></i> 4 prompt utama</span><span><i class="far fa-clock"></i> Tersimpan lokal</span><b>Kolaboratif</b></div>
                    </div>
                    <img src="/assets/messaging/herai-chat-persona.png" alt="HerAI fellow berdiskusi tentang AI Modern">
                </section>
                ...
                <section class="lesson-material-panel">
                    <div class="lesson-tabs" role="tablist" aria-label="Jenis materi">
                        ...
                        <a href="#/participant-ai-modern-discussion" class="active"><i class="far fa-message"></i> Diskusi</a>
                    </div>

                    <article class="lesson-article">
                        <div class="ml-section-head">
                            <span>Discussion Board</span>
                            <h2>Forum Pertanyaan AI Modern</h2>
                            <p>Pilih prompt atau tulis posisi sendiri. Posting dan balasan tersimpan secara lokal di browser ini.</p>
                        </div>

                        <div id="aiModernDiscussionPrompts" class="ai-modern-discussion-prompts" aria-label="Prompt diskusi Konsep AI Modern"></div>

                        <form class="practice-response-form discussion-compose ml-discussion-form" id="aiModernDiscussionForm">
                            <label>
                                <span>Prompt diskusi</span>
                                <select name="discussionPrompt">
                                    <option>Foundation model sebagai infrastruktur bersama</option>
                                    <option>Transformer dan batas context</option>
                                    <option>Agent autonomy</option>
                                    <option>Sistem AI untuk fellowship</option>
                                </select>
                            </label>
                            <label>
                                <span>Tulis posting diskusi</span>
                                <textarea rows="6" placeholder="Tulis posisi, alasan, risiko, dan contoh kasus. Input HTML akan disanitasi saat ditampilkan."></textarea>
                            </label>
                            <div class="ml-save-panel">
                                <p id="aiModernDiscussionStatus" class="practice-status" aria-live="polite">Posting akan tersimpan di browser ini.</p>
                                <button type="submit"><i class="fas fa-paper-plane"></i> Posting Diskusi</button>
                            </div>
                        </form>

                        <div class="discussion-thread" id="aiModernDiscussionList"></div>
                    </article>

                    <footer class="lesson-nav-footer">
                        <a href="#/participant-ai-modern-quiz"><i class="fas fa-chevron-left"></i> Kembali ke Kuis</a>
            ...
            <aside class="lesson-right-panel">
                <section class="module-side-card lesson-progress-card">
                    ...
                    <p>Diskusi membantu menguji keputusan desain sistem AI modern.</p>
                    <a href="#/participant-ai-modern">Buka Materi</a>
                </section>
                <section class="module-side-card lesson-list-card">
                    ...
                    <ol>
                        ...
                        <li class="completed"><span>2</span><a href="#/participant-ai-modern-practice">Latihan</a><i class="fas fa-circle-check"></i></li>
                        <li class="completed"><span>3</span><a href="#/participant-ai-modern-quiz">Kuis</a><i class="fas fa-circle-check"></i></li>
                        <li class="active"><span>4</span><a href="#/participant-ai-modern-discussion">Diskusi</a><i class="far fa-circle-play"></i></li>
                    </ol>
                </section>
            </aside>
        </div>
