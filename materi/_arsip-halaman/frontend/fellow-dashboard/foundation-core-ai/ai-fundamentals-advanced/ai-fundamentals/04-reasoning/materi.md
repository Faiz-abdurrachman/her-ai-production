...
````html
<section class="fellow-dashboard fellow-modules-page lesson-detail-page reasoning-scaffold-page ai-reasoning-page" data-fellow-page="modules">
        ...
        <div class="lesson-layout">
            <div class="lesson-main-content">
                <section class="lesson-hero">
                    <div class="lesson-hero-copy">
                        <h1>Reasoning</h1>
                        <p>Pelajari bagaimana AI menghubungkan fakta, asumsi, dan langkah untuk menyelesaikan masalah — dari memahami permintaan hingga memeriksa hasil.</p>
                        <div class="lesson-meta-row">
                            <span><i class="far fa-clock"></i> 150-180 menit</span>
                            <span><i class="fas fa-book-open"></i> Modul 4 dari 6</span>
                            <b>Final</b>
                        </div>
                    </div>
                    <img src="/assets/messaging/herai-chat-persona.png" alt="HerAI fellow belajar Reasoning">
                </section>

                <section class="lesson-material-panel">
                    <div class="lesson-tabs" role="tablist" aria-label="Jenis materi">
                        <a href="#/participant-ai-reasoning" class="active"><i class="fas fa-book-open"></i> Materi</a>
                        ...
                        <a href="#/participant-ai-reasoning-discussion"><i class="far fa-message"></i> Diskusi</a>
                    </div>
                    ...
                    <article class="lesson-article reasoning-scaffold-rich" id="materi-reasoning">
                        ...
                        <div id="chapter-pagination" style="display: flex; justify-content: space-between; align-items: center; gap: 12px; margin-top: 40px; padding-top: 24px; border-top: 1px solid var(--fellow-line);">
                            ...
                            <a href="#/participant-ai-reasoning-practice" id="btn-finish-materi" class="btn btn-primary" style="display: none; background: var(--fellow-pink); color: white; border: none; border-radius: 100px; padding: 10px 24px; font-weight: 600; box-shadow: 0 4px 12px rgba(246,51,146,.3); text-decoration: none;">
            ...
            <aside class="lesson-right-panel">
                <section class="module-side-card lesson-progress-card">
                    ...
                    <a href="#/participant-ai-reasoning">Mulai Belajar</a>
                </section>
                <section class="module-side-card lesson-list-card">
                    <h2>Daftar Materi</h2>
                    <ol id="reasoning-sidebar-list">
                        <li class="active" data-chapter="1"><span>1</span><a href="javascript:void(0)" onclick="window.loadReasoningChapter(1)">Dari Menjawab ke Menalar</a><i class="far fa-circle-play"></i></li>
                        <li data-chapter="2"><span>2</span><a href="javascript:void(0)" onclick="window.loadReasoningChapter(2)">Reasoning Dapat Diperiksa</a><i class="far fa-circle"></i></li>
                        <li data-chapter="3"><span>3</span><a href="javascript:void(0)" onclick="window.loadReasoningChapter(3)">Planning</a><i class="far fa-circle"></i></li>
                        <li data-chapter="4"><span>4</span><a href="javascript:void(0)" onclick="window.loadReasoningChapter(4)">Chain-of-Thought</a><i class="far fa-circle"></i></li>
                        <li data-chapter="5"><span>5</span><a href="javascript:void(0)" onclick="window.loadReasoningChapter(5)">Tool Use</a><i class="far fa-circle"></i></li>
                        <li data-chapter="6"><span>6</span><a href="javascript:void(0)" onclick="window.loadReasoningChapter(6)">Integrated Mission</a><i class="far fa-circle"></i></li>
                    </ol>
                </section>
