...
````html
<section class="fellow-dashboard fellow-modules-page lesson-detail-page reasoning-scaffold-page ai-reasoning-page ai-python-page" data-fellow-page="modules">
        ...
        <div class="lesson-layout">
            <div class="lesson-main-content">
                <section class="lesson-hero">
                    <div class="lesson-hero-copy">
                        <h1>Python untuk AI</h1>
                        <p>Pelajari Python dari dasar hingga siap pakai untuk AI: variabel, control flow, function, OOP, error handling, NumPy, Pandas, dan mini AI workflow.</p>
                        <div class="lesson-meta-row">
                            <span><i class="far fa-clock"></i> 150-210 menit</span>
                            <span><i class="fas fa-book-open"></i> Modul 2 dari 6</span>
                            <b>Final</b>
                        </div>
                    </div>
                    <img src="/assets/messaging/herai-chat-persona.png" alt="HerAI fellow belajar Python untuk AI">
                </section>

                <section class="lesson-material-panel">
                    <div class="lesson-tabs" role="tablist" aria-label="Jenis materi">
                        <a href="#/participant-ai-python" class="active"><i class="fas fa-book-open"></i> Materi</a>
                        ...
                        <a href="#/participant-ai-python-discussion"><i class="far fa-message"></i> Diskusi</a>
                    </div>

                    <article class="lesson-article reasoning-scaffold-rich" id="materi-reasoning">
                        <div id="reasoning-chapter-container">
                            <div style="text-align: center; padding: 60px; color: var(--fellow-muted);">
                                ...
                                <p>Memuat materi Python...</p>
                            </div>
                        </div>

                        <div id="chapter-pagination" style="display: flex; justify-content: space-between; align-items: center; gap: 12px; margin-top: 40px; padding-top: 24px; border-top: 1px solid var(--fellow-line);">
                            <button id="btn-prev-chapter" class="btn btn-outline" style="display: none; border-color: var(--fellow-pink); color: var(--fellow-pink); border-radius: 100px; padding: 10px 24px; font-weight: 600; cursor: pointer;">
                                <i class="fas fa-arrow-left" style="margin-right: 8px;"></i> Topik Sebelumnya
                            </button>
                            <div style="flex-grow: 1;"></div>
                            <button id="btn-next-chapter" class="btn btn-primary" style="display: none; background: var(--fellow-pink); color: white; border: none; border-radius: 100px; padding: 10px 24px; font-weight: 600; box-shadow: 0 4px 12px rgba(246,51,146,.3); cursor: pointer;">
                                Topik Selanjutnya <i class="fas fa-arrow-right" style="margin-left: 8px;"></i>
                            </button>
                            <a href="#/participant-ai-python-practice" id="btn-finish-materi" class="btn btn-primary" style="display: none; background: var(--fellow-pink); color: white; border: none; border-radius: 100px; padding: 10px 24px; font-weight: 600; box-shadow: 0 4px 12px rgba(246,51,146,.3); text-decoration: none;">
                                Lanjut Latihan <i class="fas fa-play" style="margin-left: 8px;"></i>
                            </a>
                        </div>
                    </article>
                </section>
            ...
            <aside class="lesson-right-panel">
                <section class="module-side-card lesson-progress-card">
                    ...
                    <p>0 dari 6 materi selesai</p>
                    <a href="#/participant-ai-python">Mulai Belajar</a>
                </section>
                <section class="module-side-card lesson-list-card">
                    <h2>Daftar Materi</h2>
                    <ol id="reasoning-sidebar-list">
                        <li class="active" data-chapter="1"><span>1</span><a href="javascript:void(0)" onclick="window.loadPythonChapter(1)">Python &amp; AI Mindset</a><i class="far fa-circle-play"></i></li>
                        <li data-chapter="2"><span>2</span><a href="javascript:void(0)" onclick="window.loadPythonChapter(2)">Data Dasar</a><i class="far fa-circle"></i></li>
                        <li data-chapter="3"><span>3</span><a href="javascript:void(0)" onclick="window.loadPythonChapter(3)">Control Flow</a><i class="far fa-circle"></i></li>
                        <li data-chapter="4"><span>4</span><a href="javascript:void(0)" onclick="window.loadPythonChapter(4)">Function &amp; Modularitas</a><i class="far fa-circle"></i></li>
                        <li data-chapter="5"><span>5</span><a href="javascript:void(0)" onclick="window.loadPythonChapter(5)">OOP untuk AI</a><i class="far fa-circle"></i></li>
                        <li data-chapter="6"><span>6</span><a href="javascript:void(0)" onclick="window.loadPythonChapter(6)">Error &amp; File</a><i class="far fa-circle"></i></li>
                    <li data-chapter="7"><span>7</span><a href="javascript:void(0)" onclick="window.loadPythonChapter(7)">Ekosistem &amp; NumPy</a><i class="far fa-circle"></i></li>
<li data-chapter="8"><span>8</span><a href="javascript:void(0)" onclick="window.loadPythonChapter(8)">Data &amp; Mini Workflow</a><i class="far fa-circle"></i></li>
</ol>
                </section>
                <section class="module-side-card lesson-note-card lesson-compact-note">
                    ...
                    <p>Catat asumsi, batasan, dan pola verifikasi yang kamu temukan.</p>
                </section>
            </aside>
        </div>
    </main>
